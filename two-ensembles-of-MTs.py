...
def energy(x1,i):#calculate the energy of the spindle systems after the kinesin-5 motors in the overlap region formed by two iMTs taking a forward step and a backward step
    ...
    for x2 in range(pair):
        ...
        ypsl22+=Kp3*(((Xkin+js5[x1][i]-l1r[x2]-js3[x1][i][x2])**2+(Xkin1+js6[x1][i]-l4l[x2]-js4[x1][i][x2])**2)/2)+Kp2*((Xpole+js0[x1][i]-l2l[x2]-js1[x1][i][x2])**2+(Xpo+js7[x1][i]-l3r[x2]-js2[x1][i][x2])**2)/2+Kp1*((Xpole+js0[x1][i]-l1l[x2]-js3[x1][i][x2])**2+(Xpo+js7[x1][i]-l4r[x2]-js4[x1][i][x2])**2)/2+Kp4*2*((Xkin1+js6[x1][i]-Xkin-js5[x1][i]-kdis)**2)/2
            ...
            #ypsl22+=Kp3*(((Xkin-l1r[x2])**2+(Xkin1-l4l[x2])**2)/2)+Kp2*((Xpole-l2l[x2])**2+(Xpo-l3r[x2])**2)/2+Kp1*((Xpole-l1l[x2])**2+(Xpo-l4r[x2])**2)/2+Kp4*2*((Xkin1-Xkin-kdis)**2)/2
...
def energyp(x1,i):#calculate the energy of the spindle systems after the kinesin-5 motors in the overlap region formed by the iMT connected to the right spindle pole and the kMT connected to the left spindle pole taking a forward step and a backward step
    ...
    ypsl22=0
    for x2 in range(pair):
        ypsl11+=Kp3*(((Xkin+zj5p[x1][i]-l1r[x2]-zj3p[x1][i][x2])**2+(Xkin1+zj6p[x1][i]-l4l[x2]-zj4p[x1][i][x2])**2)/2)+Kp2*((Xpole+zj0p[x1][i]-l2l[x2]-zj1p[x1][i][x2])**2+(Xpo+zj7p[x1][i]-l3r[x2]-zj2p[x1][i][x2])**2)/2+Kp1*((Xpole+zj0p[x1][i]-l1l[x2]-zj3p[x1][i][x2])**2+(Xpo+zj7p[x1][i]-l4r[x2]-zj4p[x1][i][x2])**2)/2+Kp4*2*((Xkin1+zj6p[x1][i]-Xkin-zj5p[x1][i]-kdis)**2)/2
        ypsl22+=Kp3*(((Xkin+js5p[x1][i]-l1r[x2]-js3p[x1][i][x2])**2+(Xkin1+js6p[x1][i]-l4l[x2]-js4p[x1][i][x2])**2)/2)+Kp2*((Xpole+js0p[x1][i]-l2l[x2]-js1p[x1][i][x2])**2+(Xpo+js7p[x1][i]-l3r[x2]-js2p[x1][i][x2])**2)/2+Kp1*((Xpole+js0p[x1][i]-l1l[x2]-js3p[x1][i][x2])**2+(Xpo+js7p[x1][i]-l4r[x2]-js4p[x1][i][x2])**2)/2+Kp4*2*((Xkin1+js6p[x1][i]-Xkin-js5p[x1][i]-kdis)**2)/2
...
def energy0():#calculate the energy of the current spindle system
    ypsl0=0
    for x2 in range(pair):
        ypsl0+=Kp3*(((Xkin-l1r[x2])**2+(Xkin1-l4l[x2])**2)/2)+Kp2*((Xpole-l2l[x2])**2+(Xpo-l3r[x2])**2)/2+Kp1*((Xpole-l1l[x2])**2+(Xpo-l4r[x2])**2)/2+Kp4*2*((Xkin1-Xkin-kdis)**2)/2
        for xn in range(nu[x2]):
