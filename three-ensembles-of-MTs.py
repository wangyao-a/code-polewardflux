...
def jiao(dxc,dxcp,dxcpx,F1,F2,F3,F4,monum,monump,monumpx):#calculate the displacements of MTs, spindle poles, and kinetochores to equilibrate the spindle apparatus again
    ...
    de=[0,[0 for x in range(pair)],[0 for x in range(pair)],[0 for x in range(pair)],[0 for x in range(pair)],0,0,0]
    num1=[0 for x in range(pair)]
    num2=[0 for x in range(pair)]
    nump1=[0 for x in range(pair)]
    nump2=[0 for x in range(pair)]
    numpx1=[0 for x in range(pair)]
    numpx2=[0 for x in range(pair)]
    fen0=[[] for x in range(pair)]
    fen1=[[] for x in range(pair)]
    fen2=[[] for x in range(pair)]
    fenp0=[[] for x in range(pair)]
    fenp1=[[] for x in range(pair)]
    fenp2=[[] for x in range(pair)]
    fenpx0=[[] for x in range(pair)]
    fenpx1=[[] for x in range(pair)]
    fenpx2=[[] for x in range(pair)]
    jisuan=[[] for x in range(pair)]
    jisuanp=[[] for x in range(pair)]
    jisuanpx=[[] for x in range(pair)]
    ji=[[] for x in range(pair)]
    F0=0
    F7=0
    F5=0
    F6=0
    ...
    #print(round(F0),F1,F2,F3,F4,round(F5,2),round(F6,2),round(F7,2))
    for x2 in range(pair):
        for xx1 in range(2):
            ta1=-1
            for xck in fen0[x2]:
    ...
    a43=Kp3;a53=round(Kp4*3,3);a63=round((-Kp3-Kp4 )*3,3);a113a=Kp3;a153=Kp3
    a04=-Kp1;a54=-Kp3;
    a05=-Kp2;
    a76=Kp2;
    a67=Kp3;a77=Kp1;
    ...
    a710=Kp2;
    a611=Kp3;a711=Kp1;
    a012=-Kp1;a512=-Kp3;a013=-Kp2;a714=Kp2;a615=Kp3;a715=Kp1;
    zq=[0 for x in range(pair)]
    cxx=[0 for x in range(pair)]
    for cx0 in range(len(ji[0])):
        ...
        for cx1 in range(len(ji[1])):
            ...
            for cx2 in range(len(ji[2])):
                ...
                ta5=ji[0][cxx[0]][13]
                ta6=ji[0][cxx[0]][14]
                a24=round(-(nump1[0]+nump2[0]+cnnkp-cnn0p)*Km,3);a34=round((nump1[0]+nump2[0]+cnnkp-cnn0p)*Km+Kp1+Kp3+Kpn5*nunum1[0]+Kpn5*nunum1[2],3)
                a104=round(-Kpn5*nunum1[0],3);a144=round(-Kpn5*nunum1[2],3)
                a15=round(((numpx1[0]+numpx2[0]+cnnkpx-cnn0px)+(num1[0]+num2[0]+cnnk-cnn0))*Km+Kp2+Kpn5*nunum[0]+Kpn5*nunum[2],3);
                a25=round(-Km*(num1[0]+num2[0]+cnnk-cnn0),3);a45=round(-(numpx1[0]+numpx2[0]+cnnkpx-cnn0px)*Km,3);a85=round(-Kpn5*nunum[0],3)
                a125=round(-Kpn5*nunum[2],3)
                a16=round((num1[0]+num2[0]+cnnk-cnn0)*Km,3);a26=round(-Km*(nump1[0]+nump2[0]+cnnkp-cnn0p+num1[0]+num2[0]+cnnk-cnn0)-Kp2-Kpn5*nunum[1]-Kpn5*nunum[3],3)
                a36=round(Km*(nump1[0]+nump2[0]+cnnkp-cnn0p),3);a96=round(Kpn5*nunum[1],3);a136=round(Kpn5*nunum[3],3)
                a17=round(Km*(numpx1[0]+numpx2[0]+cnnkpx-cnn0px),3);a47=round(-Km*(numpx1[0]+numpx2[0]+cnnkpx-cnn0px)-Kp1-Kp3-Kpn5*nunum1[1]-Kpn5*nunum1[3],3)
                a117=round(Kpn5*nunum1[1],3);a157=round(Kpn5*nunum1[3],3)
                ...
                ta5=ji[1][cxx[1]][13]
                ta6=ji[1][cxx[1]][14]
                a28=round(-(nump1[1]+nump2[1]+cnnkp-cnn0p)*Km,3);a38=round((nump1[1]+nump2[1]+cnnkp-cnn0p)*Km+Kp1+Kp3+Kpn5*nunum1[0]+Kpn5*nunum1[4],3)
                a038=round(-Kpn5*nunum1[0],3);a0148=-round(Kpn5*nunum1[4],3)
                a19=round(((numpx1[1]+numpx2[1]+cnnkpx-cnn0px)+(num1[1]+num2[1]+cnnk-cnn0))*Km+Kp2+Kpn5*nunum[0]+Kpn5*nunum[4],3);a019=round(-Kpn5*nunum[0],3)
                a29=round(-Km*(num1[1]+num2[1]+cnnk-cnn0),3);a49=round(-(numpx1[1]+numpx2[1]+cnnkpx-cnn0px)*Km,3);a0129=-round(Kpn5*nunum[4],3)
                a110=round((num1[1]+num2[1]+cnnk-cnn0)*Km,3);a210=round(-Km*(nump1[1]+nump2[1]+cnnkp-cnn0p+num1[1]+num2[1]+cnnk-cnn0)-Kp2-Kpn5*nunum[1]-Kpn5*nunum[5],3)
                a310=round(Km*(nump1[1]+nump2[1]+cnnkp-cnn0p),3);a0210=round(Kpn5*nunum[1],3);a01310=round(Kpn5*nunum[5],3)
                a111=round(Km*(numpx1[1]+numpx2[1]+cnnkpx-cnn0px),3);a411=round(-Km*(numpx1[1]+numpx2[1]+cnnkpx-cnn0px)-Kp1-Kp3-Kpn5*nunum1[1]-Kpn5*nunum1[5],3)
                a0411=round(Kpn5*nunum1[1],3);a01511=round(Kpn5*nunum1[5],3)
                ...
                ta5=ji[2][cxx[2]][13]
                ta6=ji[2][cxx[2]][14]
                a212=round(-(nump1[2]+nump2[2]+cnnkp-cnn0p)*Km,3);a312=round((nump1[2]+nump2[2]+cnnkp-cnn0p)*Km+Kp1+Kp3+Kpn5*nunum1[2]+Kpn5*nunum1[4],3)
                a0312=round(-Kpn5*nunum1[2],3);a01012=round(-Kpn5*nunum1[4],3)
                a113=round(((numpx1[2]+numpx2[2]+cnnkpx-cnn0px)+(num1[2]+num2[2]+cnnk-cnn0))*Km+Kp2+Kpn5*nunum[2]+Kpn5*nunum[4],3);a0113=-round(Kpn5*nunum[2],3)
                a213=round(-Km*(num1[2]+num2[2]+cnnk-cnn0),3);a413=round(-(numpx1[2]+numpx2[2]+cnnkpx-cnn0px)*Km,3);a0813=round(-Kpn5*nunum[4],3)
                a114=round((num1[2]+num2[2]+cnnk-cnn0)*Km,3);a214=round(-Km*(nump1[2]+nump2[2]+cnnkp-cnn0p+num1[2]+num2[2]+cnnk-cnn0)-Kp2-Kpn5*nunum[3]-Kpn5*nunum[5],3)
                a314=round(Km*(nump1[2]+nump2[2]+cnnkp-cnn0p),3);a0214=round(Kpn5*nunum[3],3);a0914=round(Kpn5*nunum[5],3)
                a115=round(Km*(numpx1[2]+numpx2[2]+cnnkpx-cnn0px),3);a415=round(-Km*(numpx1[2]+numpx2[2]+cnnkpx-cnn0px)-Kp1-Kp3-Kpn5*nunum1[3]-Kpn5*nunum1[5],3)
                a0415=round(Kpn5*nunum1[3],3);a01115=round(Kpn5*nunum1[5],3)
                b12=-Km*(dzkp[2][xx2][ta2]-dz0p[2][xx2][ta4])-F1[2]
                b13=-Km*(-dzkpx[2][xx3][ta5]+dz0px[2][xx3][ta6]+dzk[2][xx1][ta1]-dz0[2][xx1][ta3])-F2[2]
                b14=-Km*(dzkp[2][xx2][ta2]-dz0p[2][xx2][ta4]+dzk[2][xx1][ta1]-dz0[2][xx1][ta3])-F3[2]
                b15=Km*(dzkpx[2][xx3][ta5]-dz0px[2][xx3][ta6])-F4[2] 
                b=np.array([round(-F0,14),round(-F7,14),round(-F5,14),round(-F6,14),round(b4,14),round(b5,14),round(b6,14),round(b7,14),round(b8,14),round(b9,14),round(b10,14),round(b11,14),round(b12,14),round(b13,14),round(b14,14),round(b15,14)])
              
                A=np.array([[a00,a10,0,a30,0,0,0,0,a80,0,a100,0,a120,0,a140,0],[0,0,a21,0,a41,0,0,a71,0,a91,0,a111a,0,a131,0,a151],
                            [0,0,0,a32,0,a52,a62,0,0,0,a102,0,0,0,a142,0],[0,0,0,0,a43,a53,a63,0,0,0,0,a113a,0,0,0,a153],
                            [a04,0,a24,a34,0,a54,0,0,0,0,a104,0,0,0,a144,0],[a05,a15,a25,0,a45,0,0,0,a85,0,0,0,a125,0,0,0],
                            [0,a16,a26,a36,0,0,0,a76,0,a96,0,0,0,a136,0,0],[0,a17,0,0,a47,0,a67,a77,0,0,0,a117,0,0,0,a157],
                            [a08,0,0,a038,0,a58,0,0,0,a28,a38,0,0,0,a0148,0],[a09,a019,0,0,0,0,0,0,a19,a29,0,a49,a0129,0,0,0],
                            [0,0,a0210,0,0,0,0,a710,a110,a210,a310,0,0,a01310,0,0],[0,0,0,0,a0411,0,a611,a711,a111,0,0,a411,0,0,0,a01511],
                            [a012,0,0,a0312,0,a512,0,0,0,0,a01012,0,0,a212,a312,0],[a013,a0113,0,0,0,0,0,0,a0813,0,0,0,a113,a213,0,a413],
                            [0,0,a0214,0,0,0,0,a714,0,a0914,0,0,a114,a214,a314,0],[0,0,0,0,a0415,0,a615,a715,0,0,0,a01115,a115,0,0,a415]
                           ])
                ...
                de=[mtui[0],[mtui[1],mtui[8],mtui[12]],[mtui[2],mtui[9],mtui[13]],[mtui[3],mtui[10],mtui[14]],[mtui[4],mtui[11],mtui[15]],mtui[5],mtui[6],mtui[7]]
                
                chezq=0
                for x3 in range(pair):
                    check0=-1###From being subjected to a force to being free from force.
                    checkk=-1###From being not subjected to any force to being subjected to a force.
                    checkp0=-1###From being subjected to a force to being free from force.
                    checkpk=-1###From being not subjected to any force to being subjected to a force.
                    checkpx0=-1###From being subjected to a force to being free from force.
                    checkpxk=-1###From being not subjected to any force to being subjected to a force.
                    cnn0=ji[x3][cxx[x3]][0]
                    cnnk=ji[x3][cxx[x3]][1]
                ...
                if chezq==-1:
                    continue
                #print(jisuan,jisuanp,jisuanpx)
                #print(ji[0][cxx[0]],ji[1][cxx[1]],ji[2][cxx[2]])
                #print(ji)
                return de[0],de[1],de[2],de[3],de[4],de[5],de[6],de[7]
    #print(jisuan,jisuanp,jisuanpx)
    dpn=0
        ...
        for xn in range(num1[dpn]+numpx2[dpn]+num2[dpn]+numpx1[dpn]+1):#MT2
            ...
            for xn1 in range(nump2[dpn]+nump1[dpn]+1):#MT1
                ...
                if abs(tui2-lastui2)<0.0001 or abs(tui1)+abs(tui2)==0:
                    continue
                lastui2=tui2#####MT2-move-tui1,MT1-move-tui2
                F0=0
                F7=0
                F5=0
                F6=0
                    ...
                    if x2==dpn:
                        ...
                        for ton1 in range(monumpx[x2]):
                            ...
                            if jisuanpx[x2][ton1]-tui1<-xdmotor:
                                ...
                                F2[x2]-=(jisuanpx[x2][ton1]-tui1+xdmotor)*Km
                if dpn==0:
                    kua0=tui1;kua1=0;kua2=0
                if dpn==1:
                    kua0=0;kua1=tui1;kua2=0
                if dpn==2:
                    kua0=0;kua1=0;kua2=tui1
                ...
                for ton1 in range(Nma[2]):
                    if kinam[2][ton1]==1 and kinbm[2][ton1]==1:
                        F2[2]+=Kpn5*(numa[2][ton1][0]+kua2-numa[2][ton1][1]-kua0)   
                        F2[0]-=Kpn5*(numa[2][ton1][0]+kua2-numa[2][ton1][1]-kua0) 
                for ton1 in range(Nma[3]):
                    if kinam[3][ton1]==1 and kinbm[3][ton1]==1:
                        F3[2]-=Kpn5*(numa[3][ton1][0]-numa[3][ton1][1])
                        F3[0]+=Kpn5*(numa[3][ton1][0]-numa[3][ton1][1])  
                for ton1 in range(Nma[4]):
                    if kinam[4][ton1]==1 and kinbm[4][ton1]==1:
                        F2[1]+=Kpn5*(numa[4][ton1][0]+kua1-numa[4][ton1][1]-kua2)   
                        F2[2]-=Kpn5*(numa[4][ton1][0]+kua1-numa[4][ton1][1]-kua2) 
                for ton1 in range(Nma[5]):
                    if kinam[5][ton1]==1 and kinbm[5][ton1]==1:
                        F3[1]-=Kpn5*(numa[5][ton1][0]-numa[5][ton1][1])
                        F3[2]+=Kpn5*(numa[5][ton1][0]-numa[5][ton1][1])   
                if dpn==0:
                    kua0=tui2;kua1=0;kua2=0
                if dpn==1:
                    kua0=0;kua1=tui2;kua2=0
                if dpn==2:
                    kua0=0;kua1=0;kua2=tui2
                ...
                for ton1 in range(Nma1[2]):
                    if kinam1[2][ton1]==1 and kinbm1[2][ton1]==1:
                        F1[2]+=Kpn5*(numa1[2][ton1][0]+kua2-numa1[2][ton1][1]-kua0)   
                        F1[0]-=Kpn5*(numa1[2][ton1][0]+kua2-numa1[2][ton1][1]-kua0) 
                for ton1 in range(Nma1[3]):
                    if kinam1[3][ton1]==1 and kinbm1[3][ton1]==1:
                        F4[2]-=Kpn5*(numa1[3][ton1][0]-numa1[3][ton1][1])
                        F4[0]+=Kpn5*(numa1[3][ton1][0]-numa1[3][ton1][1])  
                for ton1 in range(Nma1[4]):
                    if kinam1[4][ton1]==1 and kinbm1[4][ton1]==1:
                        F1[1]+=Kpn5*(numa1[4][ton1][0]+kua1-numa1[4][ton1][1]-kua2)   
                        F1[2]-=Kpn5*(numa1[4][ton1][0]+kua1-numa1[4][ton1][1]-kua2) 
                for ton1 in range(Nma1[5]):
                    if kinam1[5][ton1]==1 and kinbm1[5][ton1]==1:
                        F4[1]-=Kpn5*(numa1[5][ton1][0]-numa1[5][ton1][1])
                        F4[2]+=Kpn5*(numa1[5][ton1][0]-numa1[5][ton1][1])  
    ...
    if tq==1:
        ...
        for xn in range(num1[dpn]+nump2[dpn]+num2[dpn]+nump1[dpn]+1):
            ...
            for xn1 in range(numpx2[dpn]+numpx1[dpn]+1):#MT4
                ...
                for ton1 in range(Nma[2]):
                    if kinam[2][ton1]==1 and kinbm[2][ton1]==1:
                        F2[2]+=Kpn5*(numa[2][ton1][0]-numa[2][ton1][1])   
                        F2[0]-=Kpn5*(numa[2][ton1][0]-numa[2][ton1][1]) 
                for ton1 in range(Nma[3]):
                    if kinam[3][ton1]==1 and kinbm[3][ton1]==1:
                        F3[2]-=Kpn5*(numa[3][ton1][0]+kua2-numa[3][ton1][1]-kua0)
                        F3[0]+=Kpn5*(numa[3][ton1][0]+kua2-numa[3][ton1][1]-kua0)
                for ton1 in range(Nma[4]):
                    if kinam[4][ton1]==1 and kinbm[4][ton1]==1:
                        F2[1]+=Kpn5*(numa[4][ton1][0]-numa[4][ton1][1])   
                        F2[2]-=Kpn5*(numa[4][ton1][0]-numa[4][ton1][1]) 
                for ton1 in range(Nma[5]):
                    if kinam[5][ton1]==1 and kinbm[5][ton1]==1:
                        F3[1]-=Kpn5*(numa[5][ton1][0]+kua1-numa[5][ton1][1]-kua2)
                        F3[2]+=Kpn5*(numa[5][ton1][0]+kua1-numa[5][ton1][1]-kua2)
                if dpn==0:
                    kua0=tui2;kua1=0;kua2=0
                if dpn==1:
                    kua0=0;kua1=tui2;kua2=0
                ...
                for ton1 in range(Nma1[2]):
                    if kinam1[2][ton1]==1 and kinbm1[2][ton1]==1:
                        F1[2]+=Kpn5*(numa1[2][ton1][0]-numa1[2][ton1][1])   
                        F1[0]-=Kpn5*(numa1[2][ton1][0]-numa1[2][ton1][1]) 
                for ton1 in range(Nma1[3]):
                    if kinam1[3][ton1]==1 and kinbm1[3][ton1]==1:
                        F4[2]-=Kpn5*(numa1[3][ton1][0]+kua2-numa1[3][ton1][1]-kua0)
                        F4[0]+=Kpn5*(numa1[3][ton1][0]+kua2-numa1[3][ton1][1]-kua0)
                for ton1 in range(Nma1[4]):
                    if kinam1[4][ton1]==1 and kinbm1[4][ton1]==1:
                        F1[1]+=Kpn5*(numa1[4][ton1][0]-numa1[4][ton1][1])   
                        F1[2]-=Kpn5*(numa1[4][ton1][0]-numa1[4][ton1][1]) 
                for ton1 in range(Nma1[5]):
                    if kinam1[5][ton1]==1 and kinbm1[5][ton1]==1:
                        F4[1]-=Kpn5*(numa1[5][ton1][0]+kua1-numa1[5][ton1][1]-kua2)
                        F4[2]+=Kpn5*(numa1[5][ton1][0]+kua1-numa1[5][ton1][1]-kua2)
                Fcc=0
                for x2 in range(pair):
                    if abs(F1[x2])+abs(F2[x2])+abs(F3[x2])+abs(F4[x2])>0.01:
                        Fcc=1
                ...
                jisuan1=[[] for x in range(pair)]
                jisuanp1=[[] for x in range(pair)]
                jisuanpx1=[[] for x in range(pair)]
                for x2 in range(pair):
                    if x2==dpn:
                        for ton1 in range(monum[x2]):
                            jisuan1[x2].append(jisuan[x2][ton1]-tui1)
                ...
                for xn3 in range(numpx2[kpn]+numpx1[kpn]+1):#MT4
                        ...
                        if x2==kpn:
                            ...
                            for ton1 in range(monumpx[x2]):
                                ...
                                if jisuanpx[x2][ton1]+tui4<-xdmotor:
                                    ...
                                    F2[x2]-=(jisuanpx[x2][ton1]+tui4+xdmotor)*Km
                    if dpn==0:
                        kua0=tui1;kua1=tui3;kua2=0
                    if dpn==1:
                        kua0=tui3;kua1=tui1;kua2=0
                    if dpn==2:
                        kua0=tui3;kua1=0;kua2=tui1
                    for ton1 in range(Nma[0]):
                        if kinam[0][ton1]==1 and kinbm[0][ton1]==1:
                            F2[0]+=Kpn5*(numa[0][ton1][0]-numa[0][ton1][1])
                            F2[1]-=Kpn5*(numa[0][ton1][0]-numa[0][ton1][1])
                    ...
                    for ton1 in range(Nma[5]):
                        if kinam[5][ton1]==1 and kinbm[5][ton1]==1:
                            ...
                            F3[2]+=Kpn5*(numa[5][ton1][0]+kua1-numa[5][ton1][1]-kua2)
                    if dpn==0:
                        kua0=tui2;kua1=tui4;kua2=0
                    if dpn==1:
                        kua0=tui4;kua1=tui2;kua2=0
                    if dpn==2:
                        kua0=tui4;kua1=0;kua2=tui2
                    for ton1 in range(Nma1[0]):
                        if kinam1[0][ton1]==1 and kinbm1[0][ton1]==1:
                            F1[0]+=Kpn5*(numa1[0][ton1][0]-numa1[0][ton1][1])
                            F1[1]-=Kpn5*(numa1[0][ton1][0]-numa1[0][ton1][1])    
                    ...
                    if tuf==1:
                        ...
                        return de[0],de[1],de[2],de[3],de[4],de[5],de[6],de[7]
    #print(p1,p2,p3,p4)
    tui33=[0 for xxx in range(pair)]
    tui22=[0 for xxx in range(pair)]
    tui11=[0 for xxx in range(pair)]
    tui44=[0 for xxx in range(pair)]
    for xxx in range(pair):
        if abs(p1[xxx])>0.1:
            tui33[xxx]=-p1[xxx]/4
        if abs(p2[xxx])>0.1:
        ...
        if abs(p4[xxx])>0.1:
            tui44[xxx]=p4[xxx]/4
    #print(tui11,tui22,tui33,tui44)
    F0=0
    F7=0
    F5=0
    F6=0
    for x2 in range(pair):
        F0+=Kp1*(l1l[x2]+tui11[x2]-Xpole)+Kp2*(l2l[x2]+tui22[x2]-Xpole)
        F7+=Kp1*(l4r[x2]+tui44[x2]-Xpo)+Kp2*(l3r[x2]+tui33[x2]-Xpo)
        F5+=Kp3*(l1r[x2]+tui11[x2]-Xkin)+Kp4*(Xkin1-Xkin-kdis)
        F6+=Kp4*(Xkin-Xkin1+kdis)+Kp3*(l4l[x2]+tui44[x2]-Xkin1)
        F3[x2]=Kp2*(Xpo-l3r[x2]-tui33[x2])
        F1[x2]=Kp1*(l1l[x2]+tui11[x2]-Xpole)+Kp3*(l1r[x2]+tui11[x2]-Xkin)
        F2[x2]=Kp2*(l2l[x2]+tui22[x2]-Xpole)
        F4[x2]=Kp1*(Xpo-l4r[x2]-tui44[x2])+Kp3*(Xkin1-l4l[x2]-tui44[x2])
        for ton1 in range(monum[x2]):
            if jisuan[x2][ton1]+tui22[x2]-tui33[x2]>xdmotor:
                F3[x2]+=(jisuan[x2][ton1]+tui22[x2]-tui33[x2]-xdmotor)*Km
                F2[x2]+=(jisuan[x2][ton1]+tui22[x2]-tui33[x2]-xdmotor)*Km
            if jisuan[x2][ton1]+tui22[x2]-tui33[x2]<-xdmotor:
                F3[x2]+=(jisuan[x2][ton1]+tui22[x2]-tui33[x2]+xdmotor)*Km
                F2[x2]+=(jisuan[x2][ton1]+tui22[x2]-tui33[x2]+xdmotor)*Km
        for ton1 in range(monump[x2]):
            if jisuanp[x2][ton1]+tui11[x2]-tui33[x2]>xdmotor:
                F3[x2]+=(jisuanp[x2][ton1]+tui11[x2]-tui33[x2]-xdmotor)*Km
                F1[x2]+=(jisuanp[x2][ton1]+tui11[x2]-tui33[x2]-xdmotor)*Km
            if jisuanp[x2][ton1]+tui11[x2]-tui33[x2]<-xdmotor:
                F3[x2]+=(jisuanp[x2][ton1]+tui11[x2]-tui33[x2]+xdmotor)*Km
                F1[x2]+=(jisuanp[x2][ton1]+tui11[x2]-tui33[x2]+xdmotor)*Km
        for ton1 in range(monumpx[x2]):
            if jisuanpx[x2][ton1]+tui44[x2]-tui22[x2]>xdmotor:
                F4[x2]-=(jisuanpx[x2][ton1]+tui44[x2]-tui22[x2]-xdmotor)*Km
                F2[x2]-=(jisuanpx[x2][ton1]+tui44[x2]-tui22[x2]-xdmotor)*Km
            if jisuanpx[x2][ton1]+tui44[x2]-tui22[x2]<-xdmotor:
                F4[x2]-=(jisuanpx[x2][ton1]+tui44[x2]-tui22[x2]+xdmotor)*Km
                F2[x2]-=(jisuanpx[x2][ton1]+tui44[x2]-tui22[x2]+xdmotor)*Km
    ...
    for ton1 in range(Nma[0]):
        if kinam[0][ton1]==1 and kinbm[0][ton1]==1:
            F2[0]+=Kpn5*(numa[0][ton1][0]-numa[0][ton1][1]+tui22[0]-tui22[1])
            F2[1]-=Kpn5*(numa[0][ton1][0]-numa[0][ton1][1]+tui22[0]-tui22[1])
    for ton1 in range(Nma[1]):
        if kinam[1][ton1]==1 and kinbm[1][ton1]==1:
            F3[0]-=Kpn5*(numa[1][ton1][0]-numa[1][ton1][1]+tui33[0]-tui33[1])
            F3[1]+=Kpn5*(numa[1][ton1][0]-numa[1][ton1][1]+tui33[0]-tui33[1])  
    for ton1 in range(Nma[2]):
        if kinam[2][ton1]==1 and kinbm[2][ton1]==1:
            F2[2]+=Kpn5*(numa[2][ton1][0]-numa[2][ton1][1]+tui22[2]-tui22[0])
            F2[0]-=Kpn5*(numa[2][ton1][0]-numa[2][ton1][1]+tui22[2]-tui22[0])
    for ton1 in range(Nma[3]):
        if kinam[3][ton1]==1 and kinbm[3][ton1]==1:
            F3[2]-=Kpn5*(numa[3][ton1][0]-numa[3][ton1][1]+tui33[2]-tui33[0])
            F3[0]+=Kpn5*(numa[3][ton1][0]-numa[3][ton1][1]+tui33[2]-tui33[0])
    for ton1 in range(Nma[4]):
        if kinam[4][ton1]==1 and kinbm[4][ton1]==1:
            F2[1]+=Kpn5*(numa[4][ton1][0]-numa[4][ton1][1]+tui22[1]-tui22[2])
            F2[2]-=Kpn5*(numa[4][ton1][0]-numa[4][ton1][1]+tui22[1]-tui22[2])
    for ton1 in range(Nma[5]):
        if kinam[5][ton1]==1 and kinbm[5][ton1]==1:
            F3[1]-=Kpn5*(numa[5][ton1][0]-numa[5][ton1][1]+tui33[1]-tui33[2])
            F3[2]+=Kpn5*(numa[5][ton1][0]-numa[5][ton1][1]+tui33[1]-tui33[2])
    for ton1 in range(Nma1[0]):
        if kinam1[0][ton1]==1 and kinbm1[0][ton1]==1:
            F1[0]+=Kpn5*(numa1[0][ton1][0]-numa1[0][ton1][1]+tui11[0]-tui11[1])
            F1[1]-=Kpn5*(numa1[0][ton1][0]-numa1[0][ton1][1]+tui11[0]-tui11[1])    
    for ton1 in range(Nma1[1]):
        if kinam1[1][ton1]==1 and kinbm1[1][ton1]==1:
            F4[0]-=Kpn5*(numa1[1][ton1][0]-numa1[1][ton1][1]+tui44[0]-tui44[1])
            F4[1]+=Kpn5*(numa1[1][ton1][0]-numa1[1][ton1][1]+tui44[0]-tui44[1])   
    for ton1 in range(Nma1[2]):
        if kinam1[2][ton1]==1 and kinbm1[2][ton1]==1:
            F1[2]+=Kpn5*(numa1[2][ton1][0]-numa1[2][ton1][1]+tui11[2]-tui11[0])   
            F1[0]-=Kpn5*(numa1[2][ton1][0]-numa1[2][ton1][1]+tui11[2]-tui11[0]) 
    for ton1 in range(Nma1[3]):
        if kinam1[3][ton1]==1 and kinbm1[3][ton1]==1:
            F4[2]-=Kpn5*(numa1[3][ton1][0]-numa1[3][ton1][1]+tui44[2]-tui44[0])
            F4[0]+=Kpn5*(numa1[3][ton1][0]-numa1[3][ton1][1]+tui44[2]-tui44[0])
    for ton1 in range(Nma1[4]):
        if kinam1[4][ton1]==1 and kinbm1[4][ton1]==1:
            F1[1]+=Kpn5*(numa1[4][ton1][0]-numa1[4][ton1][1]+tui11[1]-tui11[2])   
            F1[2]+=Kpn5*(numa1[4][ton1][0]-numa1[4][ton1][1]+tui11[1]-tui11[2]) 
    for ton1 in range(Nma1[5]):
        if kinam1[5][ton1]==1 and kinbm1[5][ton1]==1:
            F4[1]-=Kpn5*(numa1[5][ton1][0]-numa1[5][ton1][1]+tui44[1]-tui44[2])
            F4[2]+=Kpn5*(numa1[5][ton1][0]-numa1[5][ton1][1]+tui44[1]-tui44[2])
    Fcc=0
    for x2 in range(pair):
        if abs(F1[x2])+abs(F2[x2])+abs(F3[x2])+abs(F4[x2])>0.01:
            Fcc=1
    ...
    for x2 in range(pair):
        for ton1 in range(monum[x2]):
            jisuan1[x2].append(jisuan[x2][ton1]+tui22[x2]-tui33[x2])
        for ton1 in range(monump[x2]):
            jisuanp1[x2].append(jisuanp[x2][ton1]+tui11[x2]-tui33[x2])
        for ton1 in range(monumpx[x2]):
            jisuanpx1[x2].append(jisuanpx[x2][ton1]+tui44[x2]-tui22[x2])
...
def jiaocheck(jisuan,jisuanp,jisuanpx,F0,F1,F2,F3,F4,F5,F6,F7):#Auxiliary Calculation of Displacement
    num3=[0 for x in range(pair)]
    num4=[0 for x in range(pair)]
    nump3=[0 for x in range(pair)]
    nump4=[0 for x in range(pair)]
    numpx3=[0 for x in range(pair)]
    numpx4=[0 for x in range(pair)]
    ji=[[] for x in range(pair)]
    fen0=[[] for x in range(pair)]
    fen1=[[] for x in range(pair)]
    fen2=[[] for x in range(pair)]
    ...
    for cx0 in range(len(ji[0])):
        ...
        for cx1 in range(len(ji[1])):
            ...
            for cx2 in range(len(ji[2])):
                ...
                ta5=ji[0][cxx[0]][13]
                ta6=ji[0][cxx[0]][14]
                a24=round(-(nump3[0]+nump4[0]+cnnkp-cnn0p)*Km,3);a34=round((nump3[0]+nump4[0]+cnnkp-cnn0p)*Km+Kp1+Kp3+Kpn5*nunum1[0]+Kpn5*nunum1[2],3)
                a104=round(-Kpn5*nunum1[0],3);a144=round(-Kpn5*nunum1[2],3)
                a15=round(((numpx3[0]+numpx4[0]+cnnkpx-cnn0px)+(num3[0]+num4[0]+cnnk-cnn0))*Km+Kp2+Kpn5*nunum[0]+Kpn5*nunum[2],3);
                a85=round(-Kpn5*nunum[0],3);a125=round(-Kpn5*nunum[2],3)
                a25=round(-Km*(num3[0]+num4[0]+cnnk-cnn0),3);a45=round(-(numpx3[0]+numpx4[0]+cnnkpx-cnn0px)*Km,3)
                a16=round((num3[0]+num4[0]+cnnk-cnn0)*Km,3);a26=round(-Km*(nump3[0]+nump4[0]+cnnkp-cnn0p+num3[0]+num4[0]+cnnk-cnn0)-Kp2-Kpn5*nunum[1]-Kpn5*nunum[3],3)
                a36=round(Km*(nump3[0]+nump4[0]+cnnkp-cnn0p),3);a96=round(Kpn5*nunum[1],3);a136=round(Kpn5*nunum[3],3)
                a17=round(Km*(numpx3[0]+numpx4[0]+cnnkpx-cnn0px),3);a47=round(-Km*(numpx3[0]+numpx4[0]+cnnkpx-cnn0px)-Kp1-Kp3-Kpn5*nunum1[1]-Kpn5*nunum1[3],3)
                a117=round(Kpn5*nunum1[1],3);a157=round(Kpn5*nunum1[3],3)
                b4=-Km*(dzkp[0][xx2][ta2]-dz0p[0][xx2][ta4])-F1[0]
                b5=-Km*(-dzkpx[0][xx3][ta5]+dz0px[0][xx3][ta6]+dzk[0][xx1][ta1]-dz0[0][xx1][ta3])-F2[0]
                b6=-Km*(dzkp[0][xx2][ta2]-dz0p[0][xx2][ta4]+dzk[0][xx1][ta1]-dz0[0][xx1][ta3])-F3[0]
                ...
                ta5=ji[1][cxx[1]][13]
                ta6=ji[1][cxx[1]][14]
                a28=round(-(nump3[1]+nump4[1]+cnnkp-cnn0p)*Km,3);a38=round((nump3[1]+nump4[1]+cnnkp-cnn0p)*Km+Kp1+Kp3+Kpn5*nunum1[0]+Kpn5*nunum1[4],3)
                a038=round(-Kpn5*nunum1[0],3);a0148=-round(Kpn5*nunum1[4],3)
                a19=round(((numpx3[1]+numpx4[1]+cnnkpx-cnn0px)+(num3[1]+num4[1]+cnnk-cnn0))*Km+Kp2+Kpn5*nunum[0]+Kpn5*nunum[4],3);a019=round(-Kpn5*nunum[0],3)
                a29=round(-Km*(num3[1]+num4[1]+cnnk-cnn0),3);a49=round(-(numpx3[1]+numpx4[1]+cnnkpx-cnn0px)*Km,3);a0129=-round(Kpn5*nunum[4],3)
                a110=round((num3[1]+num4[1]+cnnk-cnn0)*Km,3);a210=round(-Km*(nump3[1]+nump4[1]+cnnkp-cnn0p+num3[1]+num4[1]+cnnk-cnn0)-Kp2-Kpn5*nunum[1]-Kpn5*nunum[5],3)
                a310=round(Km*(nump3[1]+nump4[1]+cnnkp-cnn0p),3);a0210=round(Kpn5*nunum[1],3);a01310=round(Kpn5*nunum[5],3)
                a111=round(Km*(numpx3[1]+numpx4[1]+cnnkpx-cnn0px),3);a411=round(-Km*(numpx3[1]+numpx4[1]+cnnkpx-cnn0px)-Kp1-Kp3-Kpn5*nunum1[1]-Kpn5*nunum1[5],3)
                a0411=round(Kpn5*nunum1[1],3);a01511=round(Kpn5*nunum1[5],3)
                b8=-Km*(dzkp[1][xx2][ta2]-dz0p[1][xx2][ta4])-F1[1]
                b9=-Km*(-dzkpx[1][xx3][ta5]+dz0px[1][xx3][ta6]+dzk[1][xx1][ta1]-dz0[1][xx1][ta3])-F2[1]
                b10=-Km*(dzkp[1][xx2][ta2]-dz0p[1][xx2][ta4]+dzk[1][xx1][ta1]-dz0[1][xx1][ta3])-F3[1]
                ...
                ta5=ji[2][cxx[2]][13]
                ta6=ji[2][cxx[2]][14]
                a212=round(-(nump3[2]+nump4[2]+cnnkp-cnn0p)*Km,3);a312=round((nump3[2]+nump4[2]+cnnkp-cnn0p)*Km+Kp1+Kp3+Kpn5*nunum1[2]+Kpn5*nunum1[4],3)
                a0312=-round(Kpn5*nunum1[2],3);a01012=round(-Kpn5*nunum1[4],3)
                a113=round(((numpx3[2]+numpx4[2]+cnnkpx-cnn0px)+(num3[2]+num4[2]+cnnk-cnn0))*Km+Kp2+Kpn5*nunum[2]+Kpn5*nunum[4],3)
                a0113=-round(Kpn5*nunum[2],3);a0813=round(-Kpn5*nunum[4],3)
                a213=round(-Km*(num3[2]+num4[2]+cnnk-cnn0),3);a413=round(-(numpx3[2]+numpx4[2]+cnnkpx-cnn0px)*Km,3)
                a114=round((num3[2]+num4[2]+cnnk-cnn0)*Km,3);a214=round(-Km*(nump3[2]+nump4[2]+cnnkp-cnn0p+num3[2]+num4[2]+cnnk-cnn0)-Kp2-Kpn5*nunum[3]-Kpn5*nunum[5],3)
                a314=round(Km*(nump3[2]+nump4[2]+cnnkp-cnn0p),3);a0214=round(Kpn5*nunum[3],3);a0914=round(Kpn5*nunum[5],3)
                a115=round(Km*(numpx3[2]+numpx4[2]+cnnkpx-cnn0px),3);a415=round(-Km*(numpx3[2]+numpx4[2]+cnnkpx-cnn0px)-Kp1-Kp3-Kpn5*nunum1[3]-Kpn5*nunum1[5],3)
                a0415=round(Kpn5*nunum1[3],3);a01115=round(Kpn5*nunum1[5],3)
                b12=-Km*(dzkp[2][xx2][ta2]-dz0p[2][xx2][ta4])-F1[2]
                b13=-Km*(-dzkpx[2][xx3][ta5]+dz0px[2][xx3][ta6]+dzk[2][xx1][ta1]-dz0[2][xx1][ta3])-F2[2]
                b14=-Km*(dzkp[2][xx2][ta2]-dz0p[2][xx2][ta4]+dzk[2][xx1][ta1]-dz0[2][xx1][ta3])-F3[2]
...
def energy(x1,i):#calculate the energy of the spindle systems after the kinesin-5 motors in the overlap region formed by two iMTs taking a forward step and a backward step
    ...
    ypsl22=0
    for x2 in range(pair):
        ypsl11+=Kp3*(((Xkin+zj5[x1][i]-l1r[x2]-zj3[x1][i][x2])**2+(Xkin1+zj6[x1][i]-l4l[x2]-zj4[x1][i][x2])**2)/2)+Kp2*((Xpole+zj0[x1][i]-l2l[x2]-zj1[x1][i][x2])**2+(Xpo+zj7[x1][i]-l3r[x2]-zj2[x1][i][x2])**2)/2+Kp1*((Xpole+zj0[x1][i]-l1l[x2]-zj3[x1][i][x2])**2+(Xpo+zj7[x1][i]-l4r[x2]-zj4[x1][i][x2])**2)/2+Kp4*3*((Xkin1+zj6[x1][i]-Xkin-zj5[x1][i]-kdis)**2)/2
        ypsl22+=Kp3*(((Xkin+js5[x1][i]-l1r[x2]-js3[x1][i][x2])**2+(Xkin1+js6[x1][i]-l4l[x2]-js4[x1][i][x2])**2)/2)+Kp2*((Xpole+js0[x1][i]-l2l[x2]-js1[x1][i][x2])**2+(Xpo+js7[x1][i]-l3r[x2]-js2[x1][i][x2])**2)/2+Kp1*((Xpole+js0[x1][i]-l1l[x2]-js3[x1][i][x2])**2+(Xpo+js7[x1][i]-l4r[x2]-js4[x1][i][x2])**2)/2+Kp4*3*((Xkin1+js6[x1][i]-Xkin-js5[x1][i]-kdis)**2)/2
    ...
    for ton1 in range(Nma[2]):   
        if kinam[2][ton1]==1 and kinbm[2][ton1]==1:
            ypsl11+=Kpn5*((numa[2][ton1][0]+zj1[x1][i][2]-numa[2][ton1][1]-zj1[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa[2][ton1][0]+js1[x1][i][2]-numa[2][ton1][1]-js1[x1][i][0])**2)/2
    for ton1 in range(Nma[3]):   
        if kinam[3][ton1]==1 and kinbm[3][ton1]==1:
            ypsl11+=Kpn5*((numa[3][ton1][0]+zj2[x1][i][2]-numa[3][ton1][1]-zj2[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa[3][ton1][0]+js2[x1][i][2]-numa[3][ton1][1]-js2[x1][i][0])**2)/2 
    for ton1 in range(Nma[4]):   
        if kinam[4][ton1]==1 and kinbm[4][ton1]==1:
            ypsl11+=Kpn5*((numa[4][ton1][0]+zj1[x1][i][1]-numa[4][ton1][1]-zj1[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa[4][ton1][0]+js1[x1][i][1]-numa[4][ton1][1]-js1[x1][i][2])**2)/2
    for ton1 in range(Nma[5]):   
        if kinam[5][ton1]==1 and kinbm[5][ton1]==1:
            ypsl11+=Kpn5*((numa[5][ton1][0]+zj2[x1][i][1]-numa[5][ton1][1]-zj2[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa[5][ton1][0]+js2[x1][i][1]-numa[5][ton1][1]-js2[x1][i][2])**2)/2
    for ton1 in range(Nma1[0]):   
        if kinam1[0][ton1]==1 and kinbm1[0][ton1]==1:
    ...
    for ton1 in range(Nma1[2]):   
        if kinam1[2][ton1]==1 and kinbm1[2][ton1]==1:
            ypsl11+=Kpn5*((numa1[2][ton1][0]+zj3[x1][i][2]-numa1[2][ton1][1]-zj3[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa1[2][ton1][0]+js3[x1][i][2]-numa1[2][ton1][1]-js3[x1][i][0])**2)/2
    for ton1 in range(Nma1[3]):   
        if kinam1[3][ton1]==1 and kinbm1[3][ton1]==1:
            ypsl11+=Kpn5*((numa1[3][ton1][0]+zj4[x1][i][2]-numa1[3][ton1][1]-zj4[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa1[3][ton1][0]+js4[x1][i][2]-numa1[3][ton1][1]-js4[x1][i][0])**2)/2 
    for ton1 in range(Nma1[4]):   
        if kinam1[4][ton1]==1 and kinbm1[4][ton1]==1:
            ypsl11+=Kpn5*((numa1[4][ton1][0]+zj3[x1][i][1]-numa1[4][ton1][1]-zj3[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa1[4][ton1][0]+js3[x1][i][1]-numa1[4][ton1][1]-js3[x1][i][2])**2)/2
    for ton1 in range(Nma1[5]):   
        if kinam1[5][ton1]==1 and kinbm1[5][ton1]==1:
            ypsl11+=Kpn5*((numa1[5][ton1][0]+zj4[x1][i][1]-numa1[5][ton1][1]-zj4[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa1[5][ton1][0]+js4[x1][i][1]-numa1[5][ton1][1]-js4[x1][i][2])**2)/2 
...
def energyp(x1,i):#calculate the energy of the spindle systems after the kinesin-5 motors in the overlap region formed by the iMT connected to the right spindle pole and the kMT connected to the left spindle pole taking a forward step and a backward step 
    ...
    ypsl22=0
    for x2 in range(pair):
        ypsl11+=Kp3*(((Xkin+zj5p[x1][i]-l1r[x2]-zj3p[x1][i][x2])**2+(Xkin1+zj6p[x1][i]-l4l[x2]-zj4p[x1][i][x2])**2)/2)+Kp2*((Xpole+zj0p[x1][i]-l2l[x2]-zj1p[x1][i][x2])**2+(Xpo+zj7p[x1][i]-l3r[x2]-zj2p[x1][i][x2])**2)/2+Kp1*((Xpole+zj0p[x1][i]-l1l[x2]-zj3p[x1][i][x2])**2+(Xpo+zj7p[x1][i]-l4r[x2]-zj4p[x1][i][x2])**2)/2+Kp4*3*((Xkin1+zj6p[x1][i]-Xkin-zj5p[x1][i]-kdis)**2)/2
        ypsl22+=Kp3*(((Xkin+js5p[x1][i]-l1r[x2]-js3p[x1][i][x2])**2+(Xkin1+js6p[x1][i]-l4l[x2]-js4p[x1][i][x2])**2)/2)+Kp2*((Xpole+js0p[x1][i]-l2l[x2]-js1p[x1][i][x2])**2+(Xpo+js7p[x1][i]-l3r[x2]-js2p[x1][i][x2])**2)/2+Kp1*((Xpole+js0p[x1][i]-l1l[x2]-js3p[x1][i][x2])**2+(Xpo+js7p[x1][i]-l4r[x2]-js4p[x1][i][x2])**2)/2+Kp4*3*((Xkin1+js6p[x1][i]-Xkin-js5p[x1][i]-kdis)**2)/2
    ...
    for ton1 in range(Nma[2]):   
        if kinam[2][ton1]==1 and kinbm[2][ton1]==1:
            ypsl11+=Kpn5*((numa[2][ton1][0]+zj1p[x1][i][2]-numa[2][ton1][1]-zj1p[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa[2][ton1][0]+js1p[x1][i][2]-numa[2][ton1][1]-js1p[x1][i][0])**2)/2
    for ton1 in range(Nma[3]):   
        if kinam[3][ton1]==1 and kinbm[3][ton1]==1:
            ypsl11+=Kpn5*((numa[3][ton1][0]+zj2p[x1][i][2]-numa[3][ton1][1]-zj2p[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa[3][ton1][0]+js2p[x1][i][2]-numa[3][ton1][1]-js2p[x1][i][0])**2)/2 
    for ton1 in range(Nma[4]):   
        if kinam[4][ton1]==1 and kinbm[4][ton1]==1:
            ypsl11+=Kpn5*((numa[4][ton1][0]+zj1p[x1][i][1]-numa[4][ton1][1]-zj1p[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa[4][ton1][0]+js1p[x1][i][1]-numa[4][ton1][1]-js1p[x1][i][2])**2)/2
    for ton1 in range(Nma[5]):   
        if kinam[5][ton1]==1 and kinbm[5][ton1]==1:
            ypsl11+=Kpn5*((numa[5][ton1][0]+zj2p[x1][i][1]-numa[5][ton1][1]-zj2p[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa[5][ton1][0]+js2p[x1][i][1]-numa[5][ton1][1]-js2p[x1][i][2])**2)/2 
    for ton1 in range(Nma1[0]):   
        if kinam1[0][ton1]==1 and kinbm1[0][ton1]==1:
    ...
    for ton1 in range(Nma1[2]):   
        if kinam1[2][ton1]==1 and kinbm1[2][ton1]==1:
            ypsl11+=Kpn5*((numa1[2][ton1][0]+zj3p[x1][i][2]-numa1[2][ton1][1]-zj3p[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa1[2][ton1][0]+js3p[x1][i][2]-numa1[2][ton1][1]-js3p[x1][i][0])**2)/2
    for ton1 in range(Nma1[3]):   
        if kinam1[3][ton1]==1 and kinbm1[3][ton1]==1:
            ypsl11+=Kpn5*((numa1[3][ton1][0]+zj4p[x1][i][2]-numa1[3][ton1][1]-zj4p[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa1[3][ton1][0]+js4p[x1][i][2]-numa1[3][ton1][1]-js4p[x1][i][0])**2)/2 
    for ton1 in range(Nma1[4]):   
        if kinam1[4][ton1]==1 and kinbm1[4][ton1]==1:
            ypsl11+=Kpn5*((numa1[4][ton1][0]+zj3p[x1][i][1]-numa1[4][ton1][1]-zj3p[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa1[4][ton1][0]+js3p[x1][i][1]-numa1[4][ton1][1]-js3p[x1][i][2])**2)/2
    for ton1 in range(Nma1[5]):   
        if kinam1[5][ton1]==1 and kinbm1[5][ton1]==1:
            ypsl11+=Kpn5*((numa1[5][ton1][0]+zj4p[x1][i][1]-numa1[5][ton1][1]-zj4p[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa1[5][ton1][0]+js4p[x1][i][1]-numa1[5][ton1][1]-js4p[x1][i][2])**2)/2 
    return ypsl11,ypsl22
...
def energypx(x1,i):#calculate the energy of the spindle systems after the kinesin-5 motors in the overlap region formed by the iMT connected to the left spindle pole and the kMT connected to the right spindle pole taking a forward step and a backward step 
    ...
    for ton1 in range(Nma[2]):   
        if kinam[2][ton1]==1 and kinbm[2][ton1]==1:
            ypsl11+=Kpn5*((numa[2][ton1][0]+zj1px[x1][i][2]-numa[2][ton1][1]-zj1px[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa[2][ton1][0]+js1px[x1][i][2]-numa[2][ton1][1]-js1px[x1][i][0])**2)/2
    for ton1 in range(Nma[3]):   
        if kinam[3][ton1]==1 and kinbm[3][ton1]==1:
            ypsl11+=Kpn5*((numa[3][ton1][0]+zj2px[x1][i][2]-numa[3][ton1][1]-zj2px[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa[3][ton1][0]+js2px[x1][i][2]-numa[3][ton1][1]-js2px[x1][i][0])**2)/2
    for ton1 in range(Nma[4]):   
        if kinam[4][ton1]==1 and kinbm[4][ton1]==1:
            ypsl11+=Kpn5*((numa[4][ton1][0]+zj1px[x1][i][1]-numa[4][ton1][1]-zj1px[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa[4][ton1][0]+js1px[x1][i][1]-numa[4][ton1][1]-js1px[x1][i][2])**2)/2
    for ton1 in range(Nma[5]):   
        if kinam[5][ton1]==1 and kinbm[5][ton1]==1:
            ypsl11+=Kpn5*((numa[5][ton1][0]+zj2px[x1][i][1]-numa[5][ton1][1]-zj2px[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa[5][ton1][0]+js2px[x1][i][1]-numa[5][ton1][1]-js2px[x1][i][2])**2)/2
    for ton1 in range(Nma1[0]):   
        if kinam1[0][ton1]==1 and kinbm1[0][ton1]==1:
    ...
    for ton1 in range(Nma1[2]):   
        if kinam1[2][ton1]==1 and kinbm1[2][ton1]==1:
            ypsl11+=Kpn5*((numa1[2][ton1][0]+zj3px[x1][i][2]-numa1[2][ton1][1]-zj3px[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa1[2][ton1][0]+js3px[x1][i][2]-numa1[2][ton1][1]-js3px[x1][i][0])**2)/2
    for ton1 in range(Nma1[3]):   
        if kinam1[3][ton1]==1 and kinbm1[3][ton1]==1:
            ypsl11+=Kpn5*((numa1[3][ton1][0]+zj4px[x1][i][2]-numa1[3][ton1][1]-zj4px[x1][i][0])**2)/2
            ypsl22+=Kpn5*((numa1[3][ton1][0]+js4px[x1][i][2]-numa1[3][ton1][1]-js4px[x1][i][0])**2)/2
    for ton1 in range(Nma1[4]):   
        if kinam1[4][ton1]==1 and kinbm1[4][ton1]==1:
            ypsl11+=Kpn5*((numa1[4][ton1][0]+zj3px[x1][i][1]-numa1[4][ton1][1]-zj3px[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa1[4][ton1][0]+js3px[x1][i][1]-numa1[4][ton1][1]-js3px[x1][i][2])**2)/2
    for ton1 in range(Nma1[5]):   
        if kinam1[5][ton1]==1 and kinbm1[5][ton1]==1:
            ypsl11+=Kpn5*((numa1[5][ton1][0]+zj4px[x1][i][1]-numa1[5][ton1][1]-zj4px[x1][i][2])**2)/2
            ypsl22+=Kpn5*((numa1[5][ton1][0]+js4px[x1][i][1]-numa1[5][ton1][1]-js4px[x1][i][2])**2)/2
    return ypsl11,ypsl22
...
def energy0():#calculate the energy of the current spindle system
    ypsl0=0
    for x2 in range(pair):
        ypsl0+=Kp3*(((Xkin-l1r[x2])**2+(Xkin1-l4l[x2])**2)/2)+Kp2*((Xpole-l2l[x2])**2+(Xpo-l3r[x2])**2)/2+Kp1*((Xpole-l1l[x2])**2+(Xpo-l4r[x2])**2)/2+Kp4*3*((Xkin1-Xkin-kdis)**2)/2
        for xn in range(nu[x2]):
    ...
    for ton1 in range(Nma[2]):   
        if kinam[2][ton1]==1 and kinbm[2][ton1]==1:
            ypsl0+=Kpn5*((numa[2][ton1][0]-numa[2][ton1][1])**2)/2
    for ton1 in range(Nma[3]):   
        if kinam[3][ton1]==1 and kinbm[3][ton1]==1:
            ypsl0+=Kpn5*((numa[3][ton1][0]-numa[3][ton1][1])**2)/2    
    for ton1 in range(Nma[4]):   
        if kinam[4][ton1]==1 and kinbm[4][ton1]==1:
            ypsl0+=Kpn5*((numa[4][ton1][0]-numa[4][ton1][1])**2)/2
    for ton1 in range(Nma[5]):   
        if kinam[5][ton1]==1 and kinbm[5][ton1]==1:
            ypsl0+=Kpn5*((numa[5][ton1][0]-numa[5][ton1][1])**2)/2  
    for ton1 in range(Nma1[0]):   
        if kinam1[0][ton1]==1 and kinbm1[0][ton1]==1:
    ...
    for ton1 in range(Nma1[2]):   
        if kinam1[2][ton1]==1 and kinbm1[2][ton1]==1:
            ypsl0+=Kpn5*((numa1[2][ton1][0]-numa1[2][ton1][1])**2)/2
    for ton1 in range(Nma1[3]):   
        if kinam1[3][ton1]==1 and kinbm1[3][ton1]==1:
            ypsl0+=Kpn5*((numa1[3][ton1][0]-numa1[3][ton1][1])**2)/2
    for ton1 in range(Nma1[4]):   
        if kinam1[4][ton1]==1 and kinbm1[4][ton1]==1:
            ypsl0+=Kpn5*((numa1[4][ton1][0]-numa1[4][ton1][1])**2)/2
    for ton1 in range(Nma1[5]):   
        if kinam1[5][ton1]==1 and kinbm1[5][ton1]==1:
            ypsl0+=Kpn5*((numa1[5][ton1][0]-numa1[5][ton1][1])**2)/2
    return ypsl0
...
def checkF():#Calculate the force of the two kinetochores, two spindle poles and four MTs
    ...
    for x2 in range(pair):
        if abs(F1[x2])+abs(F2[x2])+abs(F3[x2])+abs(F4[x2])>0.01:
            Fcc=1
    if abs(F0)+abs(F7)+abs(F5)+abs(F6)>0.01 or Fcc==1:
...
l2r=[llap for i in range(pair)]
l3l=[-llap for i in range(pair)]#the iMT connected to the right spindle pole
...
nunum=[0 for i in range(parpair)]
numa1=[[] for i in range(parpair)]
nunum1=[0 for i in range(parpair)]
...
for xn in range(8):
    ...
    kinbm[2].append(1)
    cx0=l2l[0]+round(lover/2/d*random.uniform(0,1))*d
    numa[2].append([cx0,cx0])
for xn in range(8):
    kinam[3].append(1)
    kinbm[3].append(1)
    cx0=l3r[0]-round(lover/2/d*random.uniform(0,1))*d
    numa[3].append([cx0,cx0])
...
for xbb in range(Nma[1]):
    if kinam[1][xbb]==1 and kinbm[1][xbb]==1:
        nunum[1]+=1
for xbb in range(Nma[2]):
    if kinam[2][xbb]==1 and kinbm[2][xbb]==1:
        nunum[2]+=1
for xbb in range(Nma[3]):
    if kinam[3][xbb]==1 and kinbm[3][xbb]==1:
        nunum[3]+=1
"""for xbb in range(Nma[4]):
    if kinam[4][xbb]==1 and kinbm[4][xbb]==1:
        nunum[4]+=1
for xbb in range(Nma[5]):
    if kinam[5][xbb]==1 and kinbm[5][xbb]==1:
        nunum[5]+=1"""
        
for xn in range(8):
    kinam1[0].append(1)
    kinbm1[0].append(1)
    cx0=l1l[0]+round(lover/2/d*random.uniform(0,1))*d
    numa1[0].append([cx0,cx0])
for xn in range(8):
    kinam1[1].append(1)
    kinbm1[1].append(1)
    cx0=l4r[0]-round(lover/2/d*random.uniform(0,1))*d
    numa1[1].append([cx0,cx0])
for xn in range(8):
    kinam1[2].append(1)
    kinbm1[2].append(1)
    cx0=l1l[0]+round(lover/2/d*random.uniform(0,1))*d
    numa1[2].append([cx0,cx0])
for xn in range(8):
    kinam1[3].append(1)
    kinbm1[3].append(1)
    cx0=l4r[0]-round(lover/2/d*random.uniform(0,1))*d
    numa1[3].append([cx0,cx0])
Nma1[0]=len(kinam1[0])
Nma1[1]=len(kinam1[1])
Nma1[2]=len(kinam1[2])
Nma1[3]=len(kinam1[3])
...
for xbb in range(Nma1[1]):
    if kinam1[1][xbb]==1 and kinbm1[1][xbb]==1:
        nunum1[1]+=1
for xbb in range(Nma1[2]):
    if kinam1[2][xbb]==1 and kinbm1[2][xbb]==1:
        nunum1[2]+=1
for xbb in range(Nma1[3]):
    if kinam1[3][xbb]==1 and kinbm1[3][xbb]==1:
        nunum1[3]+=1
...
for a in range(0,10000000000):
    ...
    ran4 = random.uniform(0, 1)
    ss=l1r[0]-l1l[0]
    if ran4 < konnu*round(ss/d-sum(kinam1[0]))*h:
        cx0=l1l[0]+round((l1r[0]-l1l[0])*random.uniform(0,1)/d)*d
        numa1[0].append([cx0,cx0])
        kinam1[0].append(1)
        kinbm1[0].append(0)
        Nma1[0]+=1
    ran4 = random.uniform(0, 1)
    ss=l1r[1]-l1l[1]
    if ran4 < konnu*round(ss/d-sum(kinbm1[0]))*h:
        cx0=l1l[1]+round((l1r[1]-l1l[1])*random.uniform(0,1)/d)*d
        numa1[0].append([cx0,cx0])
        kinam1[0].append(0)
        kinbm1[0].append(1)
        Nma1[0]+=1
    ran4 = random.uniform(0, 1)
    ss=l4r[0]-l4l[0]
    if ran4 < konnu*round(ss/d-sum(kinam1[1]))*h:
        cx0=l4l[0]+round((l4r[0]-l4l[0])*random.uniform(0,1)/d)*d
        numa1[1].append([cx0,cx0])
        kinam1[1].append(1)
        kinbm1[1].append(0)
        Nma1[1]+=1
    ran4 = random.uniform(0, 1)
    ss=l4r[1]-l4l[1]
    if ran4 < konnu*round(ss/d-sum(kinbm1[1]))*h:
        cx0=l4l[1]+round((l4r[1]-l4l[1])*random.uniform(0,1)/d)*d
        numa1[1].append([cx0,cx0])
        kinam1[1].append(0)
        kinbm1[1].append(1)
        Nma1[1]+=1
    ran4 = random.uniform(0, 1)
    ss=l2r[2]-l2l[2]
    if ran4 < konnu*round(ss/d-sum(kinam[2]))*h:
        cx0=l2l[2]+round((l2r[2]-l2l[2])*random.uniform(0,1)/d)*d
        numa[2].append([cx0,cx0])
        kinam[2].append(1)
        kinbm[2].append(0)
        Nma[2]+=1
    ran4 = random.uniform(0, 1)
    ss=l2r[0]-l2l[0]
    if ran4 < konnu*round(ss/d-sum(kinbm[2]))*h:
        cx0=l2l[0]+round((l2r[0]-l2l[0])*random.uniform(0,1)/d)*d
        numa[2].append([cx0,cx0])
        kinam[2].append(0)
        kinbm[2].append(1)
    ...
    ran4 = random.uniform(0, 1)
    ss=l3r[2]-l3l[2]
    if ran4 < konnu*round(ss/d-sum(kinam[3]))*h:
        cx0=l3l[2]+round((l3r[2]-l3l[2])*random.uniform(0,1)/d)*d
        numa[3].append([cx0,cx0])
        kinam[3].append(1)
        kinbm[3].append(0)
        Nma[3]+=1
    ran4 = random.uniform(0, 1)
    ss=l3r[0]-l3l[0]
    if ran4 < konnu*round(ss/d-sum(kinbm[3]))*h:
        cx0=l3l[0]+round((l3r[0]-l3l[0])*random.uniform(0,1)/d)*d
        numa[3].append([cx0,cx0])
        kinam[3].append(0)
        kinbm[3].append(1)
    ...
    ran4 = random.uniform(0, 1)
    ss=l1r[2]-l1l[2]
    if ran4 < konnu*round(ss/d-sum(kinam1[2]))*h:
        cx0=l1l[2]+round((l1r[2]-l1l[2])*random.uniform(0,1)/d)*d
        numa1[2].append([cx0,cx0])
        kinam1[2].append(1)
        kinbm1[2].append(0)
        Nma1[2]+=1
    ran4 = random.uniform(0, 1)
    ss=l1r[0]-l1l[0]
    if ran4 < konnu*round(ss/d-sum(kinbm1[2]))*h:
        cx0=l1l[0]+round((l1r[0]-l1l[0])*random.uniform(0,1)/d)*d
        numa1[2].append([cx0,cx0])
        kinam1[2].append(0)
        kinbm1[2].append(1)
    ...
    ran4 = random.uniform(0, 1)
    ss=l4r[2]-l4l[2]
    if ran4 < konnu*round(ss/d-sum(kinam1[3]))*h:
        cx0=l4l[2]+round((l4r[2]-l4l[2])*random.uniform(0,1)/d)*d
        numa1[3].append([cx0,cx0])
        kinam1[3].append(1)
        kinbm1[3].append(0)
        Nma1[3]+=1
    ran4 = random.uniform(0, 1)
    ss=l4r[0]-l4l[0]
    if ran4 < konnu*round(ss/d-sum(kinbm1[3]))*h:
        cx0=l4l[0]+round((l4r[0]-l4l[0])*random.uniform(0,1)/d)*d
        numa1[3].append([cx0,cx0])
        kinam1[3].append(0)
        kinbm1[3].append(1)
    ...
    """ran4 = random.uniform(0, 1)
    ss=l2r[1]-l2l[1]
    if ran4 < konnu*round(ss/d-sum(kinam[4]))*h:
        cx0=l2l[1]+round((l2r[1]-l2l[1])*random.uniform(0,1)/d)*d
        numa[4].append([cx0,cx0])
        kinam[4].append(1)
        kinbm[4].append(0)
        Nma[4]+=1
    ran4 = random.uniform(0, 1)
    ss=l2r[2]-l2l[2]
    if ran4 < konnu*round(ss/d-sum(kinbm[4]))*h:
        cx0=l2l[2]+round((l2r[2]-l2l[2])*random.uniform(0,1)/d)*d
        numa[4].append([cx0,cx0])
        kinam[4].append(0)
        kinbm[4].append(1)
    ...
    ran4 = random.uniform(0, 1)
    ss=l3r[1]-l3l[1]
    if ran4 < konnu*round(ss/d-sum(kinam[5]))*h:
        cx0=l3l[1]+round((l3r[1]-l3l[1])*random.uniform(0,1)/d)*d
        numa[5].append([cx0,cx0])
        kinam[5].append(1)
        kinbm[5].append(0)
        Nma[5]+=1
    ran4 = random.uniform(0, 1)
    ss=l3r[2]-l3l[2]
    if ran4 < konnu*round(ss/d-sum(kinbm[5]))*h:
        cx0=l3l[2]+round((l3r[2]-l3l[2])*random.uniform(0,1)/d)*d
        numa[5].append([cx0,cx0])
        kinam[5].append(0)
        kinbm[5].append(1)
    ...
    ran4 = random.uniform(0, 1)
    ss=l1r[1]-l1l[1]
    if ran4 < konnu*round(ss/d-sum(kinam1[4]))*h:
        cx0=l1l[1]+round((l1r[1]-l1l[1])*random.uniform(0,1)/d)*d
        numa1[4].append([cx0,cx0])
        kinam1[4].append(1)
        kinbm1[4].append(0)
        Nma1[4]+=1
    ran4 = random.uniform(0, 1)
    ss=l1r[2]-l1l[2]
    if ran4 < konnu*round(ss/d-sum(kinbm1[4]))*h:
        cx0=l1l[2]+round((l1r[2]-l1l[2])*random.uniform(0,1)/d)*d
        numa1[4].append([cx0,cx0])
        kinam1[4].append(0)
        kinbm1[4].append(1)
    ...
    ran4 = random.uniform(0, 1)
    ss=l4r[1]-l4l[1]
    if ran4 < konnu*round(ss/d-sum(kinam1[5]))*h:
        cx0=l4l[1]+round((l4r[1]-l4l[1])*random.uniform(0,1)/d)*d
        numa1[5].append([cx0,cx0])
        kinam1[5].append(1)
        kinbm1[5].append(0)
        Nma1[5]+=1
    ran4 = random.uniform(0, 1)
    ss=l4r[2]-l4l[2]
    if ran4 < konnu*round(ss/d-sum(kinbm1[5]))*h:
        cx0=l4l[2]+round((l4r[2]-l4l[2])*random.uniform(0,1)/d)*d
        numa1[5].append([cx0,cx0])
        kinam1[5].append(0)
        kinbm1[5].append(1)
...
########################################################################    
    ...
    for xbb in range(Nma[2]):
        if xbb>=Nma[2]-0.1:
            continue
        if kinam[2][xbb]==1 and kinbm[2][xbb]==1:
            if numa[2][xbb][0]>l2r[2] or numa[2][xbb][0]<l2l[2] or numa[2][xbb][1]>l2r[0] or numa[2][xbb][1]<l2l[0]:
                kinam[2][xbb]=0;kinbm[2][xbb]=0
                nunum[2]-=1
                panx=1
                pan1=1
                Nma[2]-=1
                ...
                del numa[2][xbb]
                continue
        if kinam[2][xbb]==1 and kinbm[2][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinbm[2][xbb]=1
                for xn in range(Nma[2]):
                    if kinbm[2][xn]==1 and xn!=xbb and abs(l2l[0]+round((numa[2][xbb][0]-l2l[0])/d)*d-numa[2][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l2l[0]+round((numa[2][xbb][0]-l2l[0])/d)*d>=numa[2][xbb][0]:
                        la=(round((numa[2][xbb][0]-l2l[0])/d)-1)*d
                    if l2l[0]+round((numa[2][xbb][0]-l2l[0])/d)*d<numa[2][xbb][0]:
                        la=(round((numa[2][xbb][0]-l2l[0])/d)+1)*d
                    for xn in range(Nma[2]):
                        if kinbm[2][xn]==1 and xn!=xbb and abs(l2l[2]+la-numa[2][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa[2][xbb][1]=l2l[0]+round((numa[2][xbb][0]-l2l[0])/d)*d
                if lian1==1:
                    numa[2][xbb][1]=l2l[0]+la
                if lian1==2:
                    kinbm[2][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
        ...
        if kinam[2][xbb]==0 and kinbm[2][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinam[2][xbb]=1
                for xn in range(Nma[2]):
                    if kinam[2][xn]==1 and xn!=xbb and abs(l2l[2]+round((numa[2][xbb][1]-l2l[2])/d)*d-numa[2][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l2l[2]+round((numa[2][xbb][1]-l2l[2])/d)*d>=numa[2][xbb][1]:
                        la=(round((numa[2][xbb][1]-l2l[2])/d)-1)*d
                    if l2l[2]+round((numa[2][xbb][1]-l2l[2])/d)*d<numa[2][xbb][1]:
                        la=(round((numa[2][xbb][1]-l2l[2])/d)+1)*d
                    for xn in range(Nma[2]):
                        if kinbm[2][xn]==1 and xn!=xbb and abs(l2l[2]+la-numa[2][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa[2][xbb][0]=l2l[2]+round((numa[2][xbb][1]-l2l[2])/d)*d
                if lian1==1:
                    numa[2][xbb][0]=l2l[2]+la
                if lian1==2:
                    kinam[2][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
    ...
    for xbb in range(Nma[3]):
        if xbb>=Nma[3]-0.1:
            continue
        if kinam[3][xbb]==1 and kinbm[3][xbb]==1:
            if numa[3][xbb][0]>l3r[2] or numa[3][xbb][0]<l3l[2] or numa[3][xbb][1]>l3r[0] or numa[3][xbb][1]<l3l[0]:
                kinam[3][xbb]=0;kinbm[3][xbb]=0
                nunum[3]-=1
                panx=1
                pan1=1
                Nma[3]-=1
                ...
                del numa[3][xbb]
                continue
        if kinam[3][xbb]==1 and kinbm[3][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinbm[3][xbb]=1
                lian1=0
                for xn in range(Nma[3]):
                    if kinbm[3][xn]==1 and xn!=xbb and abs(l3l[0]+round((numa[3][xbb][0]-l3l[0])/d)*d-numa[3][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l3l[0]+round((numa[3][xbb][0]-l3l[0])/d)*d>=numa[3][xbb][0]:
                        la=(round((numa[3][xbb][0]-l3l[0])/d)-1)*d
                    if l3l[0]+round((numa[3][xbb][0]-l3l[0])/d)*d<numa[3][xbb][0]:
                        la=(round((numa[3][xbb][0]-l3l[0])/d)+1)*d
                    for xn in range(Nma[3]):
                        if kinbm[3][xn]==1 and xn!=xbb and abs(l3l[0]+la-numa[3][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa[3][xbb][1]=l3l[0]+round((numa[3][xbb][0]-l3l[0])/d)*d
                if lian1==1:
                    numa[3][xbb][1]=l3l[0]+la
                if lian1==2:
                    kinbm[3][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
                    nunum[3]+=1
        if kinam[3][xbb]==0 and kinbm[3][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinam[3][xbb]=1
                lian1=0
                for xn in range(Nma[3]):
                    if kinam[3][xn]==1 and xn!=xbb and abs(l3l[2]+round((numa[3][xbb][1]-l3l[2])/d)*d-numa[3][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l3l[2]+round((numa[3][xbb][1]-l3l[2])/d)*d>=numa[3][xbb][1]:
                        la=(round((numa[3][xbb][1]-l3l[2])/d)-1)*d
                    if l3l[2]+round((numa[3][xbb][1]-l3l[2])/d)*d<numa[3][xbb][1]:
                        la=(round((numa[3][xbb][1]-l3l[2])/d)+1)*d
                    for xn in range(Nma[3]):
                        if kinbm[3][xn]==1 and xn!=xbb and abs(l3l[2]+la-numa[3][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa[3][xbb][0]=l3l[2]+round((numa[3][xbb][1]-l3l[2])/d)*d
                if lian1==1:
                    numa[3][xbb][0]=l3l[2]+la
                if lian1==2:
                    kinam[3][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
    ...
    """for xbb in range(Nma[4]):
        if xbb>=Nma[4]-0.1:
            continue
        if kinam[4][xbb]==1 and kinbm[4][xbb]==1:
            if numa[4][xbb][0]>l2r[1] or numa[4][xbb][0]<l2l[1] or numa[4][xbb][1]>l2r[2] or numa[4][xbb][1]<l2l[2]:
                kinam[4][xbb]=0;kinbm[4][xbb]=0
                nunum[4]-=1
                panx=1
                pan1=1
                Nma[4]-=1
                ...
                del numa[4][xbb]
                continue
        if kinam[4][xbb]==1 and kinbm[4][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinbm[4][xbb]=1
                for xn in range(Nma[4]):
                    if kinbm[4][xn]==1 and xn!=xbb and abs(l2l[2]+round((numa[2][xbb][0]-l2l[2])/d)*d-numa[4][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l2l[2]+round((numa[4][xbb][0]-l2l[2])/d)*d>=numa[4][xbb][0]:
                        la=(round((numa[4][xbb][0]-l2l[2])/d)-1)*d
                    if l2l[2]+round((numa[4][xbb][0]-l2l[2])/d)*d<numa[4][xbb][0]:
                        la=(round((numa[4][xbb][0]-l2l[2])/d)+1)*d
                    for xn in range(Nma[4]):
                        if kinbm[4][xn]==1 and xn!=xbb and abs(l2l[2]+la-numa[4][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa[4][xbb][1]=l2l[2]+round((numa[4][xbb][0]-l2l[2])/d)*d
                if lian1==1:
                    numa[4][xbb][1]=l2l[2]+la
                if lian1==2:
                    kinbm[4][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
        ...
        if kinam[4][xbb]==0 and kinbm[4][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinam[4][xbb]=1
                for xn in range(Nma[4]):
                    if kinam[4][xn]==1 and xn!=xbb and abs(l2l[1]+round((numa[4][xbb][1]-l2l[1])/d)*d-numa[4][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l2l[1]+round((numa[4][xbb][1]-l2l[1])/d)*d>=numa[4][xbb][1]:
                        la=(round((numa[4][xbb][1]-l2l[1])/d)-1)*d
                    if l2l[1]+round((numa[4][xbb][1]-l2l[1])/d)*d<numa[4][xbb][1]:
                        la=(round((numa[4][xbb][1]-l2l[1])/d)+1)*d
                    for xn in range(Nma[4]):
                        if kinbm[4][xn]==1 and xn!=xbb and abs(l2l[1]+la-numa[4][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa[4][xbb][0]=l2l[1]+round((numa[4][xbb][1]-l2l[1])/d)*d
                if lian1==1:
                    numa[4][xbb][0]=l2l[1]+la
                if lian1==2:
                    kinam[4][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
    ...
    for xbb in range(Nma[5]):
        if xbb>=Nma[5]-0.1:
            continue
        if kinam[5][xbb]==1 and kinbm[5][xbb]==1:
            if numa[5][xbb][0]>l3r[1] or numa[5][xbb][0]<l3l[1] or numa[5][xbb][1]>l3r[2] or numa[5][xbb][1]<l3l[2]:
                kinam[5][xbb]=0;kinbm[5][xbb]=0
                nunum[5]-=1
                panx=1
                pan1=1
                Nma[5]-=1
                ...
                del numa[5][xbb]
                continue
        if kinam[5][xbb]==1 and kinbm[5][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinbm[5][xbb]=1
                lian1=0
                for xn in range(Nma[5]):
                    if kinbm[5][xn]==1 and xn!=xbb and abs(l3l[2]+round((numa[5][xbb][0]-l3l[2])/d)*d-numa[5][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l3l[2]+round((numa[5][xbb][0]-l3l[2])/d)*d>=numa[5][xbb][0]:
                        la=(round((numa[5][xbb][0]-l3l[2])/d)-1)*d
                    if l3l[2]+round((numa[5][xbb][0]-l3l[2])/d)*d<numa[5][xbb][0]:
                        la=(round((numa[5][xbb][0]-l3l[2])/d)+1)*d
                    for xn in range(Nma[5]):
                        if kinbm[5][xn]==1 and xn!=xbb and abs(l3l[2]+la-numa[5][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa[5][xbb][1]=l3l[2]+round((numa[5][xbb][0]-l3l[2])/d)*d
                if lian1==1:
                    numa[5][xbb][1]=l3l[2]+la
                if lian1==2:
                    kinbm[5][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
                    nunum[5]+=1
        if kinam[5][xbb]==0 and kinbm[5][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinam[5][xbb]=1
                lian1=0
                for xn in range(Nma[5]):
                    if kinam[5][xn]==1 and xn!=xbb and abs(l3l[1]+round((numa[5][xbb][1]-l3l[1])/d)*d-numa[5][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l3l[1]+round((numa[5][xbb][1]-l3l[1])/d)*d>=numa[5][xbb][1]:
                        la=(round((numa[5][xbb][1]-l3l[1])/d)-1)*d
                    if l3l[1]+round((numa[5][xbb][1]-l3l[1])/d)*d<numa[5][xbb][1]:
                        la=(round((numa[5][xbb][1]-l3l[1])/d)+1)*d
                    for xn in range(Nma[5]):
                        if kinbm[5][xn]==1 and xn!=xbb and abs(l3l[1]+la-numa[5][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa[5][xbb][0]=l3l[1]+round((numa[5][xbb][3]-l3l[1])/d)*d
                if lian1==1:
                    numa[5][xbb][0]=l3l[1]+la
                if lian1==2:
                    kinam[5][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
    ...
    for xbb in range(Nma1[0]):
        if xbb>=Nma1[0]-0.1:
            continue
        if kinam1[0][xbb]==1 and kinbm1[0][xbb]==1:
            if numa1[0][xbb][0]>l1r[0] or numa1[0][xbb][0]<l1l[0] or numa1[0][xbb][1]>l1r[1] or numa1[0][xbb][1]<l1l[1]:
                kinam1[0][xbb]=0;kinbm1[0][xbb]=0
                nunum1[0]-=1
                panx=1
                pan1=1
                Nma1[0]-=1
                ...
                del numa1[0][xbb]
                continue
        if kinam1[0][xbb]==1 and kinbm1[0][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinbm1[0][xbb]=1
                for xn in range(Nma1[0]):
                    if kinbm1[0][xn]==1 and xn!=xbb and abs(l1l[1]+round((numa1[0][xbb][0]-l1l[1])/d)*d-numa1[0][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l1l[1]+round((numa1[0][xbb][0]-l1l[1])/d)*d>=numa1[0][xbb][0]:
                        la=(round((numa1[0][xbb][0]-l1l[1])/d)-1)*d
                    if l1l[1]+round((numa1[0][xbb][0]-l1l[1])/d)*d<numa1[0][xbb][0]:
                        la=(round((numa1[0][xbb][0]-l1l[1])/d)+1)*d
                    for xn in range(Nma1[0]):
                        if kinbm1[0][xn]==1 and xn!=xbb and abs(l1l[1]+la-numa1[0][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[0][xbb][1]=l1l[1]+round((numa1[0][xbb][0]-l1l[1])/d)*d
                if lian1==1:
                    numa1[0][xbb][1]=l1l[1]+la
                if lian1==2:
                    kinbm1[0][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
        ...
        if kinam1[0][xbb]==0 and kinbm1[0][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinam1[0][xbb]=1
                for xn in range(Nma1[0]):
                    if kinam1[0][xn]==1 and xn!=xbb and abs(l1l[0]+round((numa1[0][xbb][1]-l1l[0])/d)*d-numa1[0][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l1l[0]+round((numa1[0][xbb][1]-l1l[0])/d)*d>=numa1[0][xbb][1]:
                        la=(round((numa1[0][xbb][1]-l1l[0])/d)-1)*d
                    if l1l[0]+round((numa1[0][xbb][1]-l1l[0])/d)*d<numa1[0][xbb][1]:
                        la=(round((numa1[0][xbb][1]-l1l[0])/d)+1)*d
                    for xn in range(Nma1[0]):
                        if kinbm1[0][xn]==1 and xn!=xbb and abs(l1l[0]+la-numa1[0][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[0][xbb][0]=l1l[0]+round((numa1[0][xbb][1]-l1l[0])/d)*d
                if lian1==1:
                    numa1[0][xbb][0]=l1l[0]+la
                if lian1==2:
                    kinam1[0][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
    ...
    for xbb in range(Nma1[1]):
        if xbb>=Nma1[1]-0.1:
            continue
        if kinam1[1][xbb]==1 and kinbm1[1][xbb]==1:
            if numa1[1][xbb][0]>l4r[0] or numa1[1][xbb][0]<l4l[0] or numa1[1][xbb][1]>l4r[1] or numa1[1][xbb][1]<l4l[1]:
                kinam1[1][xbb]=0;kinbm1[1][xbb]=0
                nunum1[1]-=1
                panx=1
                pan1=1
                Nma1[1]-=1
                ...
                del numa1[1][xbb]
                continue
        if kinam1[1][xbb]==1 and kinbm1[1][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinbm1[1][xbb]=1
                lian1=0
                for xn in range(Nma1[1]):
                    if kinbm1[1][xn]==1 and xn!=xbb and abs(l4l[1]+round((numa1[1][xbb][0]-l4l[1])/d)*d-numa1[1][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l4l[1]+round((numa1[1][xbb][0]-l4l[1])/d)*d>=numa1[1][xbb][0]:
                        la=(round((numa1[1][xbb][0]-l4l[1])/d)-1)*d
                    if l4l[1]+round((numa1[1][xbb][0]-l4l[1])/d)*d<numa1[1][xbb][0]:
                        la=(round((numa1[1][xbb][0]-l4l[1])/d)+1)*d
                    for xn in range(Nma1[1]):
                        if kinbm1[1][xn]==1 and xn!=xbb and abs(l4l[1]+la-numa1[1][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[1][xbb][1]=l4l[1]+round((numa1[1][xbb][0]-l4l[1])/d)*d
                if lian1==1:
                    numa1[1][xbb][1]=l4l[1]+la
                if lian1==2:
                    kinbm1[1][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
                    nunum1[1]+=1
        if kinam1[1][xbb]==0 and kinbm1[1][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinam1[1][xbb]=1
                lian1=0
                for xn in range(Nma1[1]):
                    if kinam1[1][xn]==1 and xn!=xbb and abs(l4l[0]+round((numa1[1][xbb][1]-l4l[0])/d)*d-numa1[1][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l4l[0]+round((numa1[1][xbb][1]-l4l[0])/d)*d>=numa1[1][xbb][1]:
                        la=(round((numa1[1][xbb][1]-l4l[0])/d)-1)*d
                    if l4l[0]+round((numa1[1][xbb][1]-l4l[0])/d)*d<numa1[1][xbb][1]:
                        la=(round((numa1[1][xbb][1]-l4l[0])/d)+1)*d
                    for xn in range(Nma1[1]):
                        if kinbm1[1][xn]==1 and xn!=xbb and abs(l4l[0]+la-numa1[1][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[1][xbb][0]=l4l[0]+round((numa1[1][xbb][1]-l4l[0])/d)*d
                if lian1==1:
                    numa1[1][xbb][0]=l4l[0]+la
                if lian1==2:
                    kinam1[1][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
    ...
    for xbb in range(Nma1[2]):
        if xbb>=Nma1[2]-0.1:
            continue
        if kinam1[2][xbb]==1 and kinbm1[2][xbb]==1:
            if numa1[2][xbb][0]>l1r[2] or numa1[2][xbb][0]<l1l[2] or numa1[2][xbb][1]>l1r[0] or numa1[2][xbb][1]<l1l[0]:
                kinam1[2][xbb]=0;kinbm1[2][xbb]=0
                nunum1[2]-=1
                panx=1
                pan1=1
                Nma1[2]-=1
                ...
                del numa1[2][xbb]
                continue
        if kinam1[2][xbb]==1 and kinbm1[2][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinbm1[2][xbb]=1
                for xn in range(Nma1[2]):
                    if kinbm1[2][xn]==1 and xn!=xbb and abs(l1l[0]+round((numa1[2][xbb][0]-l1l[0])/d)*d-numa1[2][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l1l[0]+round((numa1[2][xbb][0]-l1l[0])/d)*d>=numa1[2][xbb][0]:
                        la=(round((numa1[2][xbb][0]-l1l[0])/d)-1)*d
                    if l1l[0]+round((numa1[2][xbb][0]-l1l[0])/d)*d<numa1[2][xbb][0]:
                        la=(round((numa1[2][xbb][0]-l1l[0])/d)+1)*d
                    for xn in range(Nma1[2]):
                        if kinbm1[2][xn]==1 and xn!=xbb and abs(l1l[0]+la-numa1[2][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[2][xbb][1]=l1l[0]+round((numa1[2][xbb][0]-l1l[0])/d)*d
                if lian1==1:
                    numa1[2][xbb][1]=l1l[0]+la
                if lian1==2:
                    kinbm1[2][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
        ...
        if kinam1[2][xbb]==0 and kinbm1[2][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinam1[2][xbb]=1
                for xn in range(Nma1[2]):
                    if kinam1[2][xn]==1 and xn!=xbb and abs(l1l[2]+round((numa1[2][xbb][1]-l1l[2])/d)*d-numa1[2][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l1l[2]+round((numa1[2][xbb][1]-l1l[2])/d)*d>=numa1[2][xbb][1]:
                        la=(round((numa1[2][xbb][1]-l1l[2])/d)-1)*d
                    if l1l[2]+round((numa1[2][xbb][1]-l1l[2])/d)*d<numa1[2][xbb][1]:
                        la=(round((numa1[2][xbb][1]-l1l[2])/d)+1)*d
                    for xn in range(Nma1[2]):
                        if kinbm1[2][xn]==1 and xn!=xbb and abs(l1l[2]+la-numa1[2][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[2][xbb][0]=l1l[2]+round((numa1[2][xbb][1]-l1l[2])/d)*d
                if lian1==1:
                    numa1[2][xbb][0]=l1l[2]+la
                if lian1==2:
                    kinam1[2][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
    ...
    for xbb in range(Nma1[3]):
        if xbb>=Nma1[3]-0.1:
            continue
        if kinam1[3][xbb]==1 and kinbm1[3][xbb]==1:
            if numa1[3][xbb][0]>l4r[2] or numa1[3][xbb][0]<l4l[2] or numa1[3][xbb][1]>l4r[0] or numa1[3][xbb][1]<l4l[0]:
                kinam1[3][xbb]=0;kinbm1[3][xbb]=0
                nunum1[3]-=1
                panx=1
                pan1=1
                Nma1[3]-=1
                ...
                del numa1[3][xbb]
                continue
        if kinam1[3][xbb]==1 and kinbm1[3][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinbm1[3][xbb]=1
                lian1=0
                for xn in range(Nma1[3]):
                    if kinbm1[3][xn]==1 and xn!=xbb and abs(l4l[0]+round((numa1[3][xbb][0]-l4l[0])/d)*d-numa1[3][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l4l[0]+round((numa1[3][xbb][0]-l4l[0])/d)*d>=numa1[3][xbb][0]:
                        la=(round((numa1[3][xbb][0]-l4l[0])/d)-1)*d
                    if l4l[0]+round((numa1[3][xbb][0]-l4l[0])/d)*d<numa1[3][xbb][0]:
                        la=(round((numa1[3][xbb][0]-l4l[0])/d)+1)*d
                    for xn in range(Nma1[3]):
                        if kinbm1[3][xn]==1 and xn!=xbb and abs(l4l[0]+la-numa1[3][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[3][xbb][1]=l4l[0]+round((numa1[3][xbb][0]-l4l[0])/d)*d
                if lian1==1:
                    numa1[3][xbb][1]=l4l[0]+la
                if lian1==2:
                    kinbm1[3][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
                    nunum1[3]+=1
        if kinam1[3][xbb]==0 and kinbm1[3][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinam1[3][xbb]=1
                lian1=0
                for xn in range(Nma1[3]):
                    if kinam1[3][xn]==1 and xn!=xbb and abs(l4l[2]+round((numa1[3][xbb][1]-l4l[2])/d)*d-numa1[3][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l4l[2]+round((numa1[3][xbb][1]-l4l[2])/d)*d>=numa1[3][xbb][1]:
                        la=(round((numa1[3][xbb][1]-l4l[2])/d)-1)*d
                    if l4l[2]+round((numa1[3][xbb][1]-l4l[2])/d)*d<numa1[3][xbb][1]:
                        la=(round((numa1[3][xbb][1]-l4l[2])/d)+1)*d
                    for xn in range(Nma1[3]):
                        if kinbm1[3][xn]==1 and xn!=xbb and abs(l4l[2]+la-numa1[3][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[3][xbb][0]=l4l[2]+round((numa1[3][xbb][1]-l4l[2])/d)*d
                if lian1==1:
                    numa1[3][xbb][0]=l4l[2]+la
                if lian1==2:
                    kinam1[3][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
                    nunum1[3]+=1
    """for xbb in range(Nma1[4]):
        if xbb>=Nma1[4]-0.1:
            continue
        if kinam1[4][xbb]==1 and kinbm1[4][xbb]==1:
            if numa1[4][xbb][0]>l1r[1] or numa1[4][xbb][0]<l1l[1] or numa1[4][xbb][1]>l1r[2] or numa1[4][xbb][1]<l1l[2]:
                kinam1[4][xbb]=0;kinbm1[4][xbb]=0
                nunum1[4]-=1
                panx=1
                pan1=1
                Nma1[4]-=1
                ...
                del numa1[4][xbb]
                continue
        if kinam1[4][xbb]==1 and kinbm1[4][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinbm1[4][xbb]=1
                for xn in range(Nma1[4]):
                    if kinbm1[4][xn]==1 and xn!=xbb and abs(l1l[2]+round((numa1[4][xbb][0]-l1l[2])/d)*d-numa1[4][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l1l[2]+round((numa1[4][xbb][0]-l1l[2])/d)*d>=numa1[4][xbb][0]:
                        la=(round((numa1[4][xbb][0]-l1l[2])/d)-1)*d
                    if l1l[2]+round((numa1[4][xbb][0]-l1l[2])/d)*d<numa1[4][xbb][0]:
                        la=(round((numa1[4][xbb][0]-l1l[2])/d)+1)*d
                    for xn in range(Nma1[4]):
                        if kinbm1[4][xn]==1 and xn!=xbb and abs(l1l[2]+la-numa1[4][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[4][xbb][1]=l1l[2]+round((numa1[4][xbb][0]-l1l[2])/d)*d
                if lian1==1:
                    numa1[4][xbb][1]=l1l[2]+la
                if lian1==2:
                    kinbm1[4][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
        ...
        if kinam1[4][xbb]==0 and kinbm1[4][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                lian1=0
                kinam1[4][xbb]=1
                for xn in range(Nma1[4]):
                    if kinam1[4][xn]==1 and xn!=xbb and abs(l1l[1]+round((numa1[4][xbb][1]-l1l[1])/d)*d-numa1[4][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l1l[1]+round((numa1[4][xbb][1]-l1l[1])/d)*d>=numa1[4][xbb][1]:
                        la=(round((numa1[4][xbb][1]-l1l[1])/d)-1)*d
                    if l1l[1]+round((numa1[4][xbb][1]-l1l[1])/d)*d<numa1[4][xbb][1]:
                        la=(round((numa1[4][xbb][1]-l1l[1])/d)+1)*d
                    for xn in range(Nma1[4]):
                        if kinbm1[4][xn]==1 and xn!=xbb and abs(l1l[1]+la-numa1[4][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[4][xbb][0]=l1l[1]+round((numa1[4][xbb][1]-l1l[1])/d)*d
                if lian1==1:
                    numa1[4][xbb][0]=l1l[1]+la
                if lian1==2:
                    kinam1[4][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
                    nunum1[4]+=1
    for xbb in range(Nma1[5]):
        if xbb>=Nma1[5]-0.1:
            continue
        if kinam1[5][xbb]==1 and kinbm1[5][xbb]==1:
            if numa1[5][xbb][0]>l4r[1] or numa1[5][xbb][0]<l4l[1] or numa1[5][xbb][1]>l4r[2] or numa1[5][xbb][1]<l4l[2]:
                kinam1[5][xbb]=0;kinbm1[5][xbb]=0
                nunum1[5]-=1
                panx=1
                pan1=1
                Nma1[5]-=1
                ...
                del numa1[5][xbb]
                continue
        if kinam1[5][xbb]==1 and kinbm1[5][xbb]==0:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinbm1[5][xbb]=1
                lian1=0
                for xn in range(Nma1[5]):
                    if kinbm1[5][xn]==1 and xn!=xbb and abs(l4l[2]+round((numa1[5][xbb][0]-l4l[2])/d)*d-numa1[5][xn][1])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l4l[2]+round((numa1[5][xbb][0]-l4l[2])/d)*d>=numa1[5][xbb][0]:
                        la=(round((numa1[5][xbb][0]-l4l[2])/d)-1)*d
                    if l4l[2]+round((numa1[5][xbb][0]-l4l[2])/d)*d<numa1[5][xbb][0]:
                        la=(round((numa1[5][xbb][0]-l4l[2])/d)+1)*d
                    for xn in range(Nma1[5]):
                        if kinbm1[5][xn]==1 and xn!=xbb and abs(l4l[2]+la-numa1[5][xn][1])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[5][xbb][1]=l4l[2]+round((numa1[5][xbb][0]-l4l[2])/d)*d
                if lian1==1:
                    numa1[5][xbb][1]=l4l[2]+la
                if lian1==2:
                    kinbm1[5][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
                    nunum1[5]+=1
        if kinam1[5][xbb]==0 and kinbm1[5][xbb]==1:
            ran4 = random.uniform(0, 1)
            if ran4 < unu*h:
                kinam1[5][xbb]=1
                lian1=0
                for xn in range(Nma1[5]):
                    if kinam1[5][xn]==1 and xn!=xbb and abs(l4l[1]+round((numa1[5][xbb][1]-l4l[1])/d)*d-numa1[5][xn][0])<1:
                        lian1=1
                        break
                if lian1==1:
                    if l4l[1]+round((numa1[5][xbb][1]-l4l[1])/d)*d>=numa1[5][xbb][1]:
                        la=(round((numa1[5][xbb][1]-l4l[1])/d)-1)*d
                    if l4l[1]+round((numa1[5][xbb][1]-l4l[1])/d)*d<numa1[5][xbb][1]:
                        la=(round((numa1[5][xbb][1]-l4l[1])/d)+1)*d
                    for xn in range(Nma1[5]):
                        if kinbm1[5][xn]==1 and xn!=xbb and abs(l4l[1]+la-numa1[5][xn][0])<1:
                            lian1=2
                            break
                if lian1==0:
                    numa1[5][xbb][0]=l4l[1]+round((numa1[5][xbb][1]-l4l[1])/d)*d
                if lian1==1:
                    numa1[5][xbb][0]=l4l[1]+la
                if lian1==2:
                    kinam1[5][xbb]=0
                if lian1==0 or lian1==1:
                    panx=1
    ...
    if panx==1:   
        ...
        if ckF==1:
            ...
            for ton1 in range(Nma1[2]):   
                if kinam1[2][ton1]==1:
                    numa1[2][ton1][0]+=de3[2]
                if kinbm1[2][ton1]==1:
                    numa1[2][ton1][1]+=de3[0]
            for ton1 in range(Nma1[3]):   
                if kinam1[3][ton1]==1:
                    numa1[3][ton1][0]+=de4[2]
                if kinbm1[3][ton1]==1:
                    numa1[3][ton1][1]+=de4[0]
            for ton1 in range(Nma1[4]):   
                if kinam1[4][ton1]==1:
                    numa1[4][ton1][0]+=de3[1]
                if kinbm1[4][ton1]==1:
                    numa1[4][ton1][1]+=de3[2]
            for ton1 in range(Nma1[5]):   
                if kinam1[5][ton1]==1:
                    numa1[5][ton1][0]+=de4[1]
                if kinbm1[5][ton1]==1:
                    numa1[5][ton1][1]+=de4[2]
            Xpole+=de0
            Xpo+=de7
            Xkin+=de5
            Xkin1+=de6
            ...
            if kina[x1][i]==1 and kinb[x1][i]==1:
                ...
                if pan[x1][i]==1 and zq==0:
                    ...
                    if na>0.1 or nb>0.1:
                        ...
                        for ton1 in range(Nma[2]):   
                            if kinam[2][ton1]==1:
                                numa[2][ton1][0]+=zj1[x1][i][2]
                            if kinbm[2][ton1]==1:
                                numa[2][ton1][1]+=zj1[x1][i][0]
                        for ton1 in range(Nma[3]):   
                            if kinam[3][ton1]==1:
                                numa[3][ton1][0]+=zj2[x1][i][2]
                            if kinbm[3][ton1]==1:
                                numa[3][ton1][1]+=zj2[x1][i][0]
                        for ton1 in range(Nma[4]):   
                            if kinam[4][ton1]==1:
                                numa[4][ton1][0]+=zj1[x1][i][1]
                            if kinbm[4][ton1]==1:
                                numa[4][ton1][1]+=zj1[x1][i][2]
                        for ton1 in range(Nma[5]):   
                            if kinam[5][ton1]==1:
                                numa[5][ton1][0]+=zj2[x1][i][1]
                            if kinbm[5][ton1]==1:
                                numa[5][ton1][1]+=zj2[x1][i][2]
                        for ton1 in range(Nma1[0]):   
                            if kinam1[0][ton1]==1:
                        ...
                        for ton1 in range(Nma1[2]):   
                            if kinam1[2][ton1]==1:
                                numa1[2][ton1][0]+=zj3[x1][i][2]
                            if kinbm1[2][ton1]==1:
                                numa1[2][ton1][1]+=zj3[x1][i][0]
                        for ton1 in range(Nma1[3]):   
                            if kinam1[3][ton1]==1:
                                numa1[3][ton1][0]+=zj4[x1][i][2]
                            if kinbm1[3][ton1]==1:
                                numa1[3][ton1][1]+=zj4[x1][i][0]
                        for ton1 in range(Nma1[4]):   
                            if kinam1[4][ton1]==1:
                                numa1[4][ton1][0]+=zj3[x1][i][1]
                            if kinbm1[4][ton1]==1:
                                numa1[4][ton1][1]+=zj3[x1][i][2]
                        for ton1 in range(Nma1[5]):   
                            if kinam1[5][ton1]==1:
                                numa1[5][ton1][0]+=zj4[x1][i][1]
                            if kinbm1[5][ton1]==1:
                                numa1[5][ton1][1]+=zj4[x1][i][2]
                    if na<-0.1 or nb<-0.1:
                        for x2 in range(pair):
                            for xn in range(nu[x2]):
                                if kina[x2][xn]==1:
                        ...
                        for ton1 in range(Nma[2]):   
                            if kinam[2][ton1]==1:
                                numa[2][ton1][0]+=js1[x1][i][2]
                            if kinbm[2][ton1]==1:
                                numa[2][ton1][1]+=js1[x1][i][0]
                        for ton1 in range(Nma[3]):   
                            if kinam[3][ton1]==1:
                                numa[3][ton1][0]+=js2[x1][i][2]
                            if kinbm[3][ton1]==1:
                                numa[3][ton1][1]+=js2[x1][i][0]
                        for ton1 in range(Nma[4]):   
                            if kinam[4][ton1]==1:
                                numa[4][ton1][0]+=js1[x1][i][1]
                            if kinbm[4][ton1]==1:
                                numa[4][ton1][1]+=js1[x1][i][2]
                        for ton1 in range(Nma[5]):   
                            if kinam[5][ton1]==1:
                                numa[5][ton1][0]+=js2[x1][i][1]
                            if kinbm[5][ton1]==1:
                                numa[5][ton1][1]+=js2[x1][i][2]
                        for ton1 in range(Nma1[0]):   
                            if kinam1[0][ton1]==1:
                        ...
                        for ton1 in range(Nma1[2]):   
                            if kinam1[2][ton1]==1:
                                numa1[2][ton1][0]+=js3[x1][i][2]
                            if kinbm1[2][ton1]==1:
                                numa1[2][ton1][1]+=js3[x1][i][0]
                        for ton1 in range(Nma1[3]):   
                            if kinam1[3][ton1]==1:
                                numa1[3][ton1][0]+=js4[x1][i][2]
                            if kinbm1[3][ton1]==1:
                                numa1[3][ton1][1]+=js4[x1][i][0]
                        for ton1 in range(Nma1[4]):   
                            if kinam1[4][ton1]==1:
                                numa1[4][ton1][0]+=js3[x1][i][1]
                            if kinbm1[4][ton1]==1:
                                numa1[4][ton1][1]+=js3[x1][i][2]
                        for ton1 in range(Nma1[5]):   
                            if kinam1[5][ton1]==1:
                                numa1[5][ton1][0]+=js4[x1][i][1]
                            if kinbm1[5][ton1]==1:
                                numa1[5][ton1][1]+=js4[x1][i][2]        
            ...
            if kinap[x1][i]==1 and kinbp[x1][i]==1:
                ...
                if panp[x1][i]==1 and zq==0:
                    ...
                    if na>0.1 or nb>0.1:
                        ...
                        for ton1 in range(Nma[2]):   
                            if kinam[2][ton1]==1:
                                numa[2][ton1][0]+=zj1p[x1][i][2]
                            if kinbm[2][ton1]==1:
                                numa[2][ton1][1]+=zj1p[x1][i][0]
                        for ton1 in range(Nma[3]):   
                            if kinam[3][ton1]==1:
                                numa[3][ton1][0]+=zj2p[x1][i][2]
                            if kinbm[3][ton1]==1:
                                numa[3][ton1][1]+=zj2p[x1][i][0]
                        for ton1 in range(Nma[4]):   
                            if kinam[4][ton1]==1:
                                numa[4][ton1][0]+=zj1p[x1][i][1]
                            if kinbm[4][ton1]==1:
                                numa[4][ton1][1]+=zj1p[x1][i][2]
                        for ton1 in range(Nma[5]):   
                            if kinam[5][ton1]==1:
                                numa[5][ton1][0]+=zj2p[x1][i][1]
                            if kinbm[5][ton1]==1:
                                numa[5][ton1][1]+=zj2p[x1][i][2]
                        for ton1 in range(Nma1[0]):   
                            if kinam1[0][ton1]==1:
                        ...
                        for ton1 in range(Nma1[2]):   
                            if kinam1[2][ton1]==1:
                                numa1[2][ton1][0]+=zj3p[x1][i][2]
                            if kinbm1[2][ton1]==1:
                                numa1[2][ton1][1]+=zj3p[x1][i][0]
                        for ton1 in range(Nma1[3]):   
                            if kinam1[3][ton1]==1:
                                numa1[3][ton1][0]+=zj4p[x1][i][2]
                            if kinbm1[3][ton1]==1:
                                numa1[3][ton1][1]+=zj4p[x1][i][0]
                        for ton1 in range(Nma1[4]):   
                            if kinam1[4][ton1]==1:
                                numa1[4][ton1][0]+=zj3p[x1][i][1]
                            if kinbm1[4][ton1]==1:
                                numa1[4][ton1][1]+=zj3p[x1][i][2]
                        for ton1 in range(Nma1[5]):   
                            if kinam1[5][ton1]==1:
                                numa1[5][ton1][0]+=zj4p[x1][i][1]
                            if kinbm1[5][ton1]==1:
                                numa1[5][ton1][1]+=zj4p[x1][i][2]
                    if na<-0.1 or nb<-0.1:
                        for x2 in range(pair):
                            for xn in range(nu[x2]):
                                if kina[x2][xn]==1:
                        ...
                        for ton1 in range(Nma[2]):   
                            if kinam[2][ton1]==1:
                                numa[2][ton1][0]+=js1p[x1][i][2]
                            if kinbm[2][ton1]==1:
                                numa[2][ton1][1]+=js1p[x1][i][0]
                        for ton1 in range(Nma[3]):   
                            if kinam[3][ton1]==1:
                                numa[3][ton1][0]+=js2p[x1][i][2]
                            if kinbm[3][ton1]==1:
                                numa[3][ton1][1]+=js2p[x1][i][0]
                        for ton1 in range(Nma[4]):   
                            if kinam[4][ton1]==1:
                                numa[4][ton1][0]+=js1p[x1][i][1]
                            if kinbm[4][ton1]==1:
                                numa[4][ton1][1]+=js1p[x1][i][2]
                        for ton1 in range(Nma[5]):   
                            if kinam[5][ton1]==1:
                                numa[5][ton1][0]+=js2p[x1][i][1]
                            if kinbm[5][ton1]==1:
                                numa[5][ton1][1]+=js2p[x1][i][2]
                        for ton1 in range(Nma1[0]):   
                            if kinam1[0][ton1]==1:
                        ...
                        for ton1 in range(Nma1[2]):   
                            if kinam1[2][ton1]==1:
                                numa1[2][ton1][0]+=js3p[x1][i][2]
                            if kinbm1[2][ton1]==1:
                                numa1[2][ton1][1]+=js3p[x1][i][0]
                        for ton1 in range(Nma1[3]):   
                            if kinam1[3][ton1]==1:
                                numa1[3][ton1][0]+=js4p[x1][i][2]
                            if kinbm1[3][ton1]==1:
                                numa1[3][ton1][1]+=js4p[x1][i][0]
                        for ton1 in range(Nma1[4]):   
                            if kinam1[4][ton1]==1:
                                numa1[4][ton1][0]+=js3p[x1][i][1]
                            if kinbm1[4][ton1]==1:
                                numa1[4][ton1][1]+=js3p[x1][i][2]
                        for ton1 in range(Nma1[5]):   
                            if kinam1[5][ton1]==1:
                                numa1[5][ton1][0]+=js4p[x1][i][1]
                            if kinbm1[5][ton1]==1:
                                numa1[5][ton1][1]+=js4p[x1][i][2]
                    ypsl0=energy0()
                    ypsl0p=ypsl0
                    ypsl0px=ypsl0
            ...
            if kinapx[x1][i]==1 and kinbpx[x1][i]==1:
                ...
                if panpx[x1][i]==1 and zq==0:
                    ...
                    if na<-0.1 or nb<-0.1:
                        ...
                        for ton1 in range(Nma[2]):   
                            if kinam[2][ton1]==1:
                                numa[2][ton1][0]+=zj1px[x1][i][2]
                            if kinbm[2][ton1]==1:
                                numa[2][ton1][1]+=zj1px[x1][i][0]
                        for ton1 in range(Nma[3]):   
                            if kinam[3][ton1]==1:
                                numa[3][ton1][0]+=zj2px[x1][i][2]
                            if kinbm[3][ton1]==1:
                                numa[3][ton1][1]+=zj2px[x1][i][0]
                        for ton1 in range(Nma[4]):   
                            if kinam[4][ton1]==1:
                                numa[4][ton1][0]+=zj1px[x1][i][1]
                            if kinbm[4][ton1]==1:
                                numa[4][ton1][1]+=zj1px[x1][i][2]
                        for ton1 in range(Nma[5]):   
                            if kinam[5][ton1]==1:
                                numa[5][ton1][0]+=zj2px[x1][i][1]
                            if kinbm[5][ton1]==1:
                                numa[5][ton1][1]+=zj2px[x1][i][2]
                        for ton1 in range(Nma1[0]):   
                            if kinam1[0][ton1]==1:
                        ...
                        for ton1 in range(Nma1[2]):   
                            if kinam1[2][ton1]==1:
                                numa1[2][ton1][0]+=zj3px[x1][i][2]
                            if kinbm1[2][ton1]==1:
                                numa1[2][ton1][1]+=zj3px[x1][i][0]
                        for ton1 in range(Nma1[3]):   
                            if kinam1[3][ton1]==1:
                                numa1[3][ton1][0]+=zj4px[x1][i][2]
                            if kinbm1[3][ton1]==1:
                                numa1[3][ton1][1]+=zj4px[x1][i][0]
                        for ton1 in range(Nma1[4]):   
                            if kinam1[4][ton1]==1:
                                numa1[4][ton1][0]+=zj3px[x1][i][1]
                            if kinbm1[4][ton1]==1:
                                numa1[4][ton1][1]+=zj3px[x1][i][2]
                        for ton1 in range(Nma1[5]):   
                            if kinam1[5][ton1]==1:
                                numa1[5][ton1][0]+=zj4px[x1][i][1]
                            if kinbm1[5][ton1]==1:
                                numa1[5][ton1][1]+=zj4px[x1][i][2]
                    if na>0.1 or nb>0.1:
                        for x2 in range(pair):
                            for xn in range(nu[x2]):
                                if kina[x2][xn]==1:
                        ...
                        for ton1 in range(Nma[2]):   
                            if kinam[2][ton1]==1:
                                numa[2][ton1][0]+=js1px[x1][i][2]
                            if kinbm[2][ton1]==1:
                                numa[2][ton1][1]+=js1px[x1][i][0]
                        for ton1 in range(Nma[3]):   
                            if kinam[3][ton1]==1:
                                numa[3][ton1][0]+=js2px[x1][i][2]
                            if kinbm[3][ton1]==1:
                                numa[3][ton1][1]+=js2px[x1][i][0]
                        for ton1 in range(Nma[4]):   
                            if kinam[4][ton1]==1:
                                numa[4][ton1][0]+=js1px[x1][i][1]
                            if kinbm[4][ton1]==1:
                                numa[4][ton1][1]+=js1px[x1][i][2]
                        for ton1 in range(Nma[5]):   
                            if kinam[5][ton1]==1:
                                numa[5][ton1][0]+=js2px[x1][i][1]
                            if kinbm[5][ton1]==1:
                                numa[5][ton1][1]+=js2px[x1][i][2]
                        for ton1 in range(Nma1[0]):   
                            if kinam1[0][ton1]==1:
                        ...
                        for ton1 in range(Nma1[2]):   
                            if kinam1[2][ton1]==1:
                                numa1[2][ton1][0]+=js3px[x1][i][2]
                            if kinbm1[2][ton1]==1:
                                numa1[2][ton1][1]+=js3px[x1][i][0]
                        for ton1 in range(Nma1[3]):   
                            if kinam1[3][ton1]==1:
                                numa1[3][ton1][0]+=js4px[x1][i][2]
                            if kinbm1[3][ton1]==1:
                                numa1[3][ton1][1]+=js4px[x1][i][0]
                        for ton1 in range(Nma1[4]):   
                            if kinam1[4][ton1]==1:
                                numa1[4][ton1][0]+=js3px[x1][i][1]
                            if kinbm1[4][ton1]==1:
                                numa1[4][ton1][1]+=js3px[x1][i][2]
                        for ton1 in range(Nma1[5]):   
                            if kinam1[5][ton1]==1:
                                numa1[5][ton1][0]+=js4px[x1][i][1]
                            if kinbm1[5][ton1]==1:
                                numa1[5][ton1][1]+=js4px[x1][i][2]
                    ypsl0=energy0()
                    ypsl0p=ypsl0
                    ypsl0px=ypsl0
        ...
        for xbb in range(nu[x1]):
            if kina[x1][xbb]==0 and kinb[x1][xbb]==1:
                ...
                if kinb[x1][xbb]==1 and kina[x1][xbb]==1:
                    ...
                    pan1=1
                    monum[x1]+=1
            if kina[x1][xbb]==1 and kinb[x1][xbb]==0:
                ...
                if kinb[x1][xbb]==1 and kina[x1][xbb]==1:
                    ...
                    pan1=1
                    monum[x1]+=1
            if kina[x1][xbb]==1 and kinb[x1][xbb]==1:
                F=0
                if motor[x1][xbb][0]-motor[x1][xbb][1]>xdmotor:
                    F=Km*(motor[x1][xbb][0]-motor[x1][xbb][1]-xdmotor)
                if motor[x1][xbb][0]-motor[x1][xbb][1]<-xdmotor:
                    F=Km*(motor[x1][xbb][0]-motor[x1][xbb][1]+xdmotor)
                kina[x1][xbb]=dissociation(F,ypsl0,ypsl1[x1][xbb],ypsl2[x1][xbb])
                kinb[x1][xbb]=dissociation(F,ypsl0,ypsl1[x1][xbb],ypsl2[x1][xbb])
                ...
                if kina[x1][xbb]==0 or kinb[x1][xbb]==0:
                    ...
                    if ckF==1:
                        ...
                        for ton1 in range(Nma1[3]):   
                            if kinam1[3][ton1]==1:
                                numa1[3][ton1][0]+=de4[0]
                            if kinbm1[3][ton1]==1:
                                numa1[3][ton1][1]+=de4[2]
                        for ton1 in range(Nma1[4]):   
                            if kinam1[4][ton1]==1:
                                numa1[4][ton1][0]+=de3[1]
                            if kinbm1[4][ton1]==1:
...
##################################################################
        ...
        for xbb in range(nu1[x1]):
            if kinap[x1][xbb]==0 and kinbp[x1][xbb]==1:
                ...
                if kinbp[x1][xbb]==1 and kinap[x1][xbb]==1:
                    ...
                    pan1=1
                    monump[x1]+=1
            if kinap[x1][xbb]==1 and kinbp[x1][xbb]==0:
                ...
                if kinbp[x1][xbb]==1 and kinap[x1][xbb]==1:
                    ...
                    pan1=1
                    monump[x1]+=1
            if kinap[x1][xbb]==1 and kinbp[x1][xbb]==1:
                F=0
                if motorp[x1][xbb][0]-motorp[x1][xbb][1]>xdmotor:
                    F=Km*(motorp[x1][xbb][0]-motorp[x1][xbb][1]-xdmotor)
                if motorp[x1][xbb][0]-motorp[x1][xbb][1]<-xdmotor:
                    F=Km*(motorp[x1][xbb][0]-motorp[x1][xbb][1]+xdmotor)
                kinap[x1][xbb]=dissociation(F,ypsl0p,ypsl1p[x1][xbb],ypsl2p[x1][xbb])
                kinbp[x1][xbb]=dissociation(F,ypsl0p,ypsl1p[x1][xbb],ypsl2p[x1][xbb])
        ...
        for xbb in range(nu1x[x1]):
            if kinapx[x1][xbb]==0 and kinbpx[x1][xbb]==1:
                ...
                if kinbpx[x1][xbb]==1 and kinapx[x1][xbb]==1:
                    ...
                    pan1=1
                    monumpx[x1]+=1
            if kinapx[x1][xbb]==1 and kinbpx[x1][xbb]==0:
                ...
                if kinbpx[x1][xbb]==1 and kinapx[x1][xbb]==1:
                    ...
                    pan1=1
                    monumpx[x1]+=1
            if kinapx[x1][xbb]==1 and kinbpx[x1][xbb]==1:
                F=0
                if motorpx[x1][xbb][0]-motorpx[x1][xbb][1]>xdmotor:
                    F=-Km*(motorpx[x1][xbb][0]-motorpx[x1][xbb][1]-xdmotor)
                if motorpx[x1][xbb][0]-motorpx[x1][xbb][1]<-xdmotor:
                    F=-Km*(motorpx[x1][xbb][0]-motorpx[x1][xbb][1]+xdmotor)
                kinapx[x1][xbb]=dissociation(F,ypsl0px,ypsl1px[x1][xbb],ypsl2px[x1][xbb])
                kinbpx[x1][xbb]=dissociation(F,ypsl0px,ypsl1px[x1][xbb],ypsl2px[x1][xbb])
    ...
    if sum(lxian)<0 or Xpole>0:
        break
    if a%1000==0:

        print(round(a*h,1),monum,monump,monumpx,round(Xkin,2),round(Xkin1,2),round(numpy.mean(lxian[0]),1),round(numpy.mean(lxian[1]),1),round(numpy.mean(lxian[2]),1),round(Xpo-Xpole),round(((ximta2[0])-Ximt2[0]),2),round((numpy.mean(xkmta1)-numpy.mean(Xkmt1)),2),round((numpy.mean(desi2)-numpy.mean(desia2)),2),round((numpy.mean(desk1)-numpy.mean(deska1)),2),round((numpy.mean(pos1)-numpy.mean(posa1)),2),round(Kp2*(l2l[0]-Xpole),2),round(Kp2*(l2l[1]-Xpole),2))
        for x2 in range(pair):
            desia2[x2]=desi2[x2]
            deska1[x2]=desk1[x2]
            posa1[x2]=pos1[x2]
