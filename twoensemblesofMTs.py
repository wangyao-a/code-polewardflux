...
for a in range(18172725,20000000):
...
0.0003/0.003 Kp0.1/10/0.03 5-4-0.5 Fp3.2 6 dif82 1nM 3d/2 


# In[18]:


print(round(a*h),round(numpy.mean(monum)),round(numpy.mean(monump)),round(numpy.mean(monumpx)),round(numpy.mean(nunum)),round(Xkin,2),round(Xkin1,2),round(numpy.mean(lxian[0]),1),round(numpy.mean(lxian[1]),1),round(Xpo-Xpole),round(((ximta2[0])-Ximt2[0]),2),round(((ximta3[0])-Ximt3[0]),2),round(((ximta2[1])-Ximt2[1]),2),round(((ximta3[1])-Ximt3[1]),2),round(((xkmta1[0])-Xkmt1[0]),2),round(((xkmta4[0])-Xkmt4[0]),2),round(((xkmta1[1])-Xkmt1[1]),2),round(((xkmta4[1])-Xkmt4[1]),2),round((numpy.mean(desi2)-numpy.mean(desia2)),2),round((numpy.mean(desk1)-numpy.mean(deska1)),2),round((numpy.mean(pos1)-numpy.mean(posa1)),2),round(Kp2*(l2l[0]-Xpole),2),round(Kp2*(l2l[1]-Xpole),2))
...
ckF,de0,de1,de2,de3,de4,de5,de6,de7=checkF()#1,0,[0,0],[0,0],[-10,10],[0,0],0,0,0#checkF()
if ckF==1:
    for x2 in range(pair):
        for xn in range(nu[x2]):
            if kina[x2][xn]==1:
